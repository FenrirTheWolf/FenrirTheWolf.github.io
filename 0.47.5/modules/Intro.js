undum.game.intro = {
    start: new undum.SimpleSituation(
          ...
          debug: new undum.SimpleSituation(
                  ...
                  oper(system, "./magic", "MAGIC","./dbspecies","Species");
                  oper(system, "./timejumper", "Jump ahead a day","./timejumper2","jump ahead 4 days");
                    oper(system, "./hachart", "Harmonizey","./tfery","Tfery","./blinky","SUBLIMINAL!");
                         oper(system, "./checkrunes", "check runes","./arttest","SHalonify!","./next","Next sprite");
                          ...
                          oper(system ,"./linkery","Beam me up!");
            ...
            "clothed": function (character, system, action) {
             ...
             clother();
                  ...
                  "raptor": function (character, system, action) {
                       var nh= character.sandbox.nh["ravel"];
                 ...
                 character.sandbox.ch2=true;
                  ...
                  character.host=character.sandbox.nh["ravel"];
  ...
  //                                  
              ...
              parer("WARNING this is still in the process of being buit! The scenes do not match up with the characters perfectly yet as this is a MASSIVE process to make chapter 2. However they will function! It will be helpfull to locate scenes that just don't match up with them to make a note of them as important ones to create chapter 2 versions of!");
