  ...
  //                        
                                ...
                                oper(system, "./wantstay", "You want to be his cock! FULLY","./wantun","Agree with him"); 
                                         ...
                                         //Happy with the players size
                                             ...
                                             oper(system, "./calm", "Stay silent like agood cock" ,"./complain","Tell him you would rather change back to normal!");
                                          }
  ...
  //                 }
              ...
              system.doLink("./eveningstuffout");
                ...
                "wantun": function (character, system, action) {
                  transer();
                   system.setQuality("harmony",character.qualities.harmony+1 );
                  parer("You agree with him on this, having a bit more of your boby back would be nice. Plus it means getting closer and closer to managing to reverse this whole mess. DIspite that he doesn't seem intent on changing you to back fully... Just a bit to where he likes your shape the most.");
                 system.doLink("./eveningstuffout");
                }, //function close
                ...
                "indep": function (character, system, action) {
                  ...
                  if(character.sandbox.limits.cantalk){
                    ...
                    parer("You know what you want to say to him but due to your situation telling him is a bit difficult. You already know you are likely going to be like this for the rest of your life. It's going to be a constant push to keep reminding yourself you are a person that looks liek a cock, an individual. Rather than a slightly special cock attached to host.");
                  ...
                  switch (character.sandbox.carryevening) {
                    case "horny":
                      //                          oper(system,"./","Sounds like a good idea to you!", "./", "You have moods other than just 'horny'!");
                            //oper(system,"./","Agree with him about the horny part!", "./", "Blame him for some of that hornyness!");
                            //oper(system,"./","What good is a cock if not constantly horny?", "./", "He is the one making you cum so often!");
                      parer(["It is literally what you are now, the very source of arousal and lust... It is hard to have thoughts that don't lead you to blasting cum from your mouth! ","You wouldn't be a very good dick if your entire exsistance didn't focus on being horny! It's your job to be ready and throbbing at any moment host wants to use you!"]);
                       ...
                       oper(system, "./sogood", "Tell him to keep rubbing!","./resisturge","Barely mumble out a 'nooo...'","./moan","Just moan");
                        ...
                        if(character.qualities.essence>= character.sandbox.ttcost&&character.sandbox.runedo.thoughts){
                          ...
                          if(!character.sandbox.runedo.thoughts){
                              parer("He doesn't hear you say anything then rubs over your piss slit! q1You can't talk so I guess I should just take that as a yes? Better use that mind link thing otherwise...q1 He says, but you disabled that rune! Your body is so hard you can't even wiggle or move beyond throbing!");
