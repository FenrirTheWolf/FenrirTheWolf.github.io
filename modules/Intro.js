  ...
  start: new undum.SimpleSituation(
          "",
          {
            enter: function (character, system) {
              ...
              parer("For the last 25 years you have lived a fairly normal life, went to school, got a job, got your own place, got into college. Even had a girlfriend for a short time. ");
              
              parer("You live in a mixed neighborhood, mostly furrs and a few scalies and maybe a handful of taurs the most. Only a few of them were non native forms, usually the result of some strange magics or bizarre experimental machine. Weird transformations were very rare but not unheard off.");
              
              parer("You are sleeping when a sudden knock at the door wakes you up.");
        ...
        debug: new undum.SimpleSituation(
                ...
                character.sandbox.saveloc="debug/enter";
                character.sandbox.debugrun=false;
                character.qualities.day=20;
                spark=true;
                oper(system, "./lynxy", "Dari bend over plz");
                oper(system, "./hoss", "Will!","./liony","Dominic","./rar","leika");
                oper(system, "./raptor", "Clever girl","./horny","HORNY","./clothed","Fuck clothing");
                oper(system, "./magic", "MAGIC","./dbspecies","Species","./partest","Some words");
                oper(system, "./timejumper", "Jump ahead a day","./timejumper2","jump ahead 4 days");
                  oper(system, "./hachart", "Harmonizey","./tfery","Tfery","./blinky","SUBLIMINAL!");
                       oper(system, "./checkrunes", "check runes","./arttest","SHalonify!","./next","Next sprite");
                        ...
                        oper(system ,"./linkery","Beam me up!","./ch2skiper","take me to chapter 2!");
          ...
          "dbspecies": function (character, system, action) {
            ...
            oper(system, "./dbfeline", "Feline","./dbcanine","canince");
              ...
              "magic": function (character, system, action) {
                character.sandbox.host = character.nh["dominic"];
            //character.sandbox.scenerexit= "newhostpicked/enter";
if(character.sandbox.host.scenes.masturbate){
var scener="masturbate";
   oper(system,(character.sandbox.host.host+"host"+scener+"/scene1"), "Just a placeholder here.", "ravelhostgreet/scene1", "Hold on to your butts....");
}else{
...
//<linearGradient id="gradient2" x1="0%" y1="0%" x2="100%" y2="50%" spreadMethod="pad"><stop offset="0%" stop-color="red" stop-opacity="1"></stop><stop offset="50%" stop-color="white" stop-opacity="1"></stop><stop offset="100%" stop-opacity="1" stop-color="grey"></stop></linearGradient></defs><g><rect x="0" y="0" width="100%" height="60" style="fill: url(&quot;#gradient2&quot;);"><circle cx="'+character.qualities.harmony+'" cy="'+character.qualities.dignitylost+'" r="2"></circle></g><g><text class="svgtext" y="6" x="1">Horny</text></g><g><text text-anchor="end" class="svgtext" style="text-anchor: end;" y="6" x="99">Bored</text></g></svg>');
            ...
            oper(system, "./lusttestup", "SEXY","./lusttestdown","Not sexy!","./lusttestnow","WTF is wrong");
           ...
           // character.sandbox.perma=true;
               ...
               //   system.doLink("transformation/runeactions");
                ...
                //system.doLink("ch2/fiddler");
                  ...
                  oper(system, "./", "");
                  oper(system, "ch2morning/sleep", "morning fix plz");
...
//                                  
            ...
            parer("WARNING this is still in the process of being built! There are numerous h#osts to find if you are horny enough. Not all locations are built yet. Head to the museum if you need help finding a specific ho#st.");
          ...
          "hostchoosy": function (character, system, action) {
                ...
                oper(system, "./hckeagen", "Keagen","./hcmark","Mark");
              }, //function close
          ...
          system.doLink("ch2/fiddler");
              ...
              "examine": function (character, system, action) {
                ...
                parer("<p>\
                                         ...
                                         that you haven't even heard of. But at least you know who sent\
          ...
          , {
            ...
            actions: {
              ...
              "second": function (character, system, action) {
                transer();
                parer("<p>The second page seems to be translations for some of the symbols that you see on the artifact. It's mostly gibberish but it generally says things like sacrifice and pleasure but it seems whoever was translating it stopped half way. However the translated words 'incredible length' and 'marvelous size' are circled in red. It's hard to not raise an eyebrow at the prospect of 'unnatural male enhancement' Regardless you should probably keep it in a more private location.</p>");
          ...
          "", {
            ...
            actions: {
              ...
              "type20": function (character, system, action) {
                //20%= minor shrinking, no legs, attached to groin
                parer("After the panic of the situation has finished host stands in front of the mirror\
                                                        looking over what has happened to both of you.</p><p>Thankfully the transformation didn't seem to get very far. You are only a few feet shorter but your legs have been completely absorbed by his now MASSIVE balls. The rest of your body is mostly unchanged. At best only about 20% of your body has been transformed, though your waist is merged with host's groin.");
                if (character.sandbox.host.host == "mark" || character.sandbox.host.host == "keagen") {
                  parer("host" + ((character.sandbox.host.host == "keagen") ? "Sighs looking down at you. \"That artifact is far more than some male enhancement device. I never expected this is what it intended by giving you a longer cock. But if it can cause this it certainly can undo it. Stilll.... This is weird.\" " : " shakes his head looking at you both in the mirror. \"Damn... there is no way we can go out in public looking like this... I really hope you can explain what the hell is going on, and why you are currently attached to my groin!\""));
                  character.sandbox.limits.goout = false;
                } else {
                  //its bret
                  parer("host shakes his head looking at you both in the mirror. \"If I wear a long overcoat you should be able to stay hidden with a harness to keep you secure under me. Still I really hope you can explain what the hell is going on, and why you are currently attached to my groin\"");
                }
                ;
            ...
            transer();
            parer("Despite the sensations of wonderful pleasure that tingling just keeps getting stronger! You can't quite place it though! The cum pumping through you feels better and better each time it happens and you start to lose track of it... Somewhere in the back of your mind it occurs to you, it feels like you are going a bit numb from over stimulation! Everything... is getting.... so hard to think....");
            oper(system, "./milking", ".......");
          }, //function close
   ...
   oper(system, "./milkingtoforgotten", "...... Cum again... and again");
        ...
        realization: new undum.SimpleSituation(
                ...
                transer();
                        ...
                        oper(system, "./home", "Try to get used to your new home");
          ...
          "", {
            ...
            actions: {
              ...
              "afterglow": function (character, system, action) {
                transer();
                parer("The flow of cum finally slows till it is just a trickle occasionally filling your mouth. Once your mouth is clear enough you get the chance to gasp and pant in exhaustion\
            ...
            actions: {
              ...
              "wait": function (character, system, action) {
               ...
               // system.setQuality("timeofday", character.qualities.timeofday + 1);
                ...
                oper(system, "newhome/masturbate", "Suggest some fun before you both sleep", "newhome/sleep", "Head to sleep with no fooling around");
                character.sandbox.headingholder = "Your";
