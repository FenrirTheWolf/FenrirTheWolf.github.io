    ...
    transformation: new undum.SimpleSituation(
        "", {
            enter: function(character, system, action) {
                ...
                if ((character.sandbox.gooutcount > 2)) {
            ...
            actions: {
                ...
                "runeactions": function(character, system, action) {
                    ...
                    switch (character.sandbox.activerune) {
                            ...
                            if (character.sandbox.host.host == "will" || (character.sandbox.host.cocktype == "reptile" && character.sandbox.cocktype == character.sandbox.host.cocktype)) {
                                ...
                                if (character.sandbox.cocktype == "reptile") {
                                    ...
                                    if (character.qualities.ctf >= 95) {
                                        ...
                                        runeaction = "You activate the rune and feel farm more thin, narrower at the tip espeically! It's like your entire body tapers into a sleek tentacle. You even feel a bit more mobile and almost prehensile!";
                                    } else {
                            ...
                            if (character.sandbox.host.host == "will" || (character.sandbox.cocktype == "feline" && character.sandbox.cocktype == character.sandbox.host.cocktype)) {
                                ...
                                if (character.sandbox.cocktype == "feline") {
                                    ...
                                    if (character.qualities.ctf >= 95) {
                                        ...
                                        runeaction = "You activate the rune and feel your shape change slight, your nomrally uniform shape seems to grow numbs and details. Though you may have the shape of a feline cock, anthro felines have only a hint of those nub like structures.";
                                    } else {
                        ...
                        case "feedback":
                            ...
                            system.animateQuality("essence", 0, {
                                displayValue: false,
                                from: 1,
                                to: 0
                            });
                    ...
                    switch (switchesholder) {
                        ...
                        case 3:
                            ...
                            if (character.sandbox.limits.hasarms && character.sandbox.limits.cantalk) {
                                system.animateQuality("essence", character.qualities.essence - 15, {
                                    from: 1,
                                    to: 0
                                });
                ...
                "tfstandard": function(character, system, action) {
                    ...
                    system.animateQuality("ctf", ctfnum, {
                        displayValue: false,
                        from: character.qualities.ctf / 100,
                        to: ctfnum / 100
                    });
                ...
                "tfreversion": function(character, system, action) {
                    ...
                    if (character.qualities.ctf >= 100) {
                        if (character.qualities.essence >= 30) {
                            ...
                            system.animateQuality("ctf", ctfnumnew, {
                                displayValue: false,
                                from: character.qualities.ctf / 100,
                                to: ctfnumnew / 100
                            });
                            system.animateQuality("essence", character.qualities.essence - remess, {
                                from: 1,
                                to: 0
                            });
                            character.sandbox.tfed = true;
