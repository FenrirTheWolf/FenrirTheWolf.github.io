        ...
        "", {
            actions: {
                ...
                "eveningmbnewhost": function(character, system, action) {
                    ...
                    console.log("Scene test: " + character.sandbox.host.host + "host" + scener + "/scene1");
      ...
      punishment condoms: can always be used. 60% minimum
                ...
                "apologize": function(character, system, action) {
                    ...
                    if (character.sandbox.ttcarryover) {
                        ...
                        system.animateQuality("essence", character.qualities.essence - character.sandbox.ttcost, {
                            from: character.qualities.essence,
                            to: character.qualities.essence - character.sandbox.ttcost
                        });
                ...
                "plugnope": function(character, system, action) {
                    ...
                    //oper(system, "./pillponder", "Struggle with it helplessly as you end up also getting some sleep.");
                }, //function close
