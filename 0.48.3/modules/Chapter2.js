ch2msg= function (character, system, from) {
 ...
 //Posssesive lion might muscles but has a small pee pee.
 //Dominic 
 ...
 home: new undum.SimpleSituation(
   ...
   mall: new undum.SimpleSituation(
     ...
     system.setQuality("currency",character.qualities.currency-10);
             parer("You end up taking one of the feminine lace underwear with you to check out. You can't help but feel a little embarrassed taking them to the check out with you, especially since they obviously have extra cloth for ones bulge. Then again it might be even more embarrassing to imagine yourself trapped inside them!");
           ...
           "learn": function (character, system, action) {
             transer();
                ...
                if(character.qualities.lust>60){
                  ...
                  parer("You try your best to focus on all the dusty boring old books but all you can really think about is how much more fun this was before. A hand softly rubbing over you, keeping you nice and hard while you read throug the pages. Cum occasionally leaking from your mouth in the process sometimes. There is a sudden shiver that goes up your spine as you feel host suddenly rub his cock... It causes you to moun out loud and what feels like cum floods into your mouth! You quickly have to leave the building before you get in trouble for noise... or stains...");
                   ch2hoster(character, system);
                   ch2menuer(character,system);
                }else{
