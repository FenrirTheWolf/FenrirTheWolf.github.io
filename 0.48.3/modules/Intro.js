      ...
      "", {
          ...
          actions: {
              ...
              "ch2skip": function(character, system, action) {
                  ...
                  parer("WARNING this is still in the process of being built! The scenes do not match up with the characters perfectly yet as this is a MASSIVE process to make chapter 2. However they will function! It will be helpfull to locate scenes that just don't match up with them to make a note of them as important ones to create chapter 2 versions of!");

                  parer("There are MANY MANY hosts hidden around with multiple writers!");
                  parer("Errr... I mean There are MANY MANY characters hidden around with multiple writers!");
          ...
          actions: {
              ...
              "explainh": function(character, system, action) {
                  ...
                  if (character.sandbox.stealth) {
                      ...
                      system.animateQuality("essence", character.qualities.essence - 50, {
                          from: character.qualities.essence,
                          to: character.qualities.essence - 50
                      });
  ...
  mark: new undum.SimpleSituation("", {
      ...
      actions: {
          ...
          "mistake": function(character, system, action) {
              ...
              system.animateQuality("essence", character.qualities.essence + 80, {
                  from: 0,
                  to: 1
              });
