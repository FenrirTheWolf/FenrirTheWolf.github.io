        ...
        "", {
            actions: {
                ...
                "callpasthost": function(character, system, action) {
                    ...
                    alert("a " + JSON.stringify(character.sandbox.pasthost));
                    var nh = character.sandbox.nh[character.sandbox.pasthost];

                    character.sandbox.currenthostparse = nh.parse;
                    character.sandbox.host = character.sandbox.nh[character.sandbox.pasthost];
                    character.host = character.sandbox.nh[character.sandbox.pasthost];
                ...
                "present": function(character, system, action) {
                    transer();
                    parer("Full sex scene coming in a future update");
