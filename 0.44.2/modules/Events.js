            ...
            actions: {
                "enter": function(character, system, action) {
                    ...
                    switch (character.sandbox.eventholder) {
                        ...
                        case "caged":
                            delh1 = [
                                "You decide to just try to wait it out in the cage. Maybe even get some sleep. It's restrictive in the device but sort of comfortable in it's own way..",
                        ...
                        case "relaxout":
                            ...
                            delh2 = [
                                ...
                                "It just feels so right to relax inside host's pants, right where you belong. It is almost a low euphoria knowing you are being a good body-part for host.",
                            ...
                            delh3 = [
                                ...
                                "You relax into the mindset of being a cock so much that it almost feels too real. For a while you almost forget how to move just letting hosts body have full control over you..."
                            ];
                            break;
                        case "instincts":
                            //character.sandbox.mind++;
                        ...
                        case "friendly":
                            ...
                            if (character.sandbox.limits.cantalk) {
                                delh3 = [
                                    ...
                                    "You actually spend a surprising amount of the day talking with host. It has been a slow enough day that no one was around to overhear you.",
                        ...
                        case "wait":
                            ...
                            //Maybe make a special set for just brets harness to increase the text options.
                        ...
                        case "horny":
                            ...
                            delh2 = [
                                ...
                                (character.sandbox.limits.hasarms) ? "You waste no time in sliding your hands up and down your sensitive body! host lets out a grumble and moves around trying to adjust you into a more comfortable position!" : "Its a bit hard without arms but you manage to wiggle around rubbing against your surroundings. host lets out a grumble and moves around trying to adjust you into a more comfortable position!",
                    ...
                    if (character.sandbox.runedo.horny) {
                        ...
                        worky[1] = "host seems to spend a surprising amount of time rubbing you in the middle of the day. You only start getting hard for a moments before he stops himself each time";
                            ...
                            if (character.sandbox.host.host == "keagen" && character.sandbox.forgottenstealth) {
                                worky = [
                                    ...
                                    "At one point you here him explaining something about arcane stuff, something about keeping artifacts sealed and how dangerous they can be.", [
                                        "There is a mention of a magic ring as Keagen talks to someone q1Yea I came across it by chance. My first rune scares came from it. Errr no I can't show them off, they are umm on my penis.q1 He says with a bit of embarrassment",
                                        "Someone is asking him if its safe or something.... He just laughs them off q1Don't worry my err... I have a massive essence reservoir if anything goes wrongq1 He says.",
                                        "Keagen is talking with someone and you catch a mention of runes, q1Still haven't figured out what happened to the guy that give me the ring. Never saw him again after that day. Really weirdq1 He says with shrug"
                                    ]
                                ];
                            }
                ...
                "halfway2": function(character, system, action) {
                    //restroom or work stuff leads to here this is the true half way
                    ...
                    if (character.sandbox.buyringplz && rnd() > 8) {
                        ...
                        if (character.sandbox.perma) {
                            ...
                            parer("host is just wandering as far as you can tell through town when you hear him make a rather sudden surprise gasp. There is an exchange of questions and soon he has rushed to a bathroom stall....");
                    ...
                    switch (hornymod) {
                        ...
                        case 2:
                            ...
                            if (outmorecheck) {
                                ...
                                parer("host finishes up and heads downtown, you can tell by the sound of a train. Finally he enters into a somewhat familiar building, you are pretty sure it's the gym. A few moments later you hear some rustling and suddenly LIGHT! q1Hey, just doing some excersizes. Can't really let you out for long though, just had to change.q1 he says, taking off his clothes before sliding something MUCH tighter up and over you! This is WAY worse than underwear! The gym shorts now containing you buldge out over your form! Anyone looking at the shorts can totally see the buldge you are making even though you can't see them!");
                                ...
                                if (character.sandbox.permalock || character.sandbox.permaplugged) {
                                    ...
                                    if (character.sandbox.stayhidden) {
                                        ...
                                        //normal route
                                        parer("host finishes up and heads downtown, you can tell by the sound of a train. Finally he enters into a somewhat familiar building, you are pretty sure it's the gym. You can't exactly tell which piece of equipment he is using but you are suddenly squished up against it! There is a movement followed by freedom.... then another and you are all squished again! Squish release, squish release over and over! It doesn't hurt but it's certainly no fun! He doesn't do this for very long and eventually gets tired of it and heads back out.");
                                    } //normal end
                            ...
                            try {
                                ...
                                if (character.sandbox.ch2 && (character.sandbox.host.scenes[scener])) {
                                    ...
                                    if (outmorecheck) {
                                        ...
                                        parer("He gives you a few rubs during the meal, really making it hard to not want him to go all out! You are left throbbing desperately as he finishes his meal and hides you away again.");
                ...
                "nothing": function(character, system, action) {
                    ...
                    if (character.sandbox.toys.cage) {
                        ...
                        if (character.sandbox.toys.condom) {
                            ...
                            parer("He just laughs and grabs a pack of large condoms! q1Well if you say so.... Maybe this will help you to stop making me extra horny all the time!q1 He says and hides you away! Being stuck in underwear all day is bad enough but a condom!? The idea of being trapped inside a condom is oddly exciting but also worrying!");
                        ...
                        parer("He just laughs and grabs one of the largest cock cages! q1Well if you say so.... Maybe this will help you to stop making me extra horny all the time!q1 He says and hides you away! You really didn't want him to pick THAT! He wouldn't ACTUALLY put you in a chastity cage....... right?");
