undum.game.sex = {
            ...
            if(character.sandbox.metbefore[character.sandbox.splistchoice][0]){
              ...
              if(character.sandbox.host.pref=="straight"){
               pronounholder="She";
                ...
                //BIG
                if(character.sandbox.host.pref=="straight"){
                   parer("You hear some talking from host and someone else and soon you are getting pulled out into the open. Almost instatnly you start getting hard as you look up to see the " + bigspecieslist[character.sandbox.splistchoice]+" smiling down at you! She is absolutely massive, not in a bad way.... You actually recognize them as someone that you have played with before!");
                }else{
                   parer("You hear some talking from host and someone else and soon you are getting pulled out into the open. Almost instatnly you start getting hard as you look up to see the " + bigspecieslist[character.sandbox.splistchoice]+" smiling down at you! He is absolutely massive, not in a bad way.... You actually recognize them as someone that you have played with before!");
                ...
                //normal
                   if(character.sandbox.host.pref=="straight"){
                   parer("You hear some talking from host and someone else and soon you are getting pulled out into the open. Almost instatnly you start getting hard as you look up to see the " + specieslist[character.sandbox.splistchoice]+" smiling down at you! You actually recognize them as someone that you have played with before!");
                }else{
                   parer("You hear some talking from host and someone else and soon you are getting pulled out into the open. Almost instatnly you start getting hard as you look up to see the " + specieslist[character.sandbox.splistchoice]+" smiling down at you! You actually recognize them as someone that you have played with before!");
                     ...
                     parer(reactions[character.sandbox.metbefore[character.sandbox.splistchoice][2]]+" "+pronounholder+" says and gives you a few rubs");
              ...
              if(character.qualities.ctf<40&&why){
                //BIG
                if(character.sandbox.host.pref=="straight"){
                   parer("You hear some talking from host and someone else and soon you are getting pulled out into the open. Almost instatnly you start getting hard as you look up to see the" + bigspecieslist[character.sandbox.splistchoice]+" smiling down at you! She is absolutely massive, not in a bad way.... Then again you are rather shorter than you used to be but still they are intimidating!");
                }else{
                   parer("You hear some talking from host and someone else and soon you are getting pulled out into the open. Almost instatnly you start getting hard as you look up to see the" + bigspecieslist[character.sandbox.splistchoice]+" smiling down at you! He is absolutely massive, not in a bad way.... Then again you are rather shorter than you used to be but still she is intimidating!");
                ...
                //normal
                   if(character.sandbox.host.pref=="straight"){
                   parer("You hear some talking from host and someone else and soon you are getting pulled out into the open. Almost instatnly you start getting hard as you look up to see the" + specieslist[character.sandbox.splistchoice]+" smiling down at you!");
                }else{
                   parer("You hear some talking from host and someone else and soon you are getting pulled out into the open. Almost instatnly you start getting hard as you look up to see the" + specieslist[character.sandbox.splistchoice]+" smiling down at you!");
       ...
       system.doLink("./hostrespond");
          ...
          switch(character.sandbox.ctfrolemod){
            case "pos":
              ...
              break;
            case "bod":
                 respond="q1It's just my cock now, I don't treat it any diffrently now than before.q1";
              break;
 ...
 var sp=""; 
          ...
          "partialsuckend": function (character, system, action) {
            ...
            parer("On the final thrust the "+sp+" pulls your head into their groin actually causing your nose to slip inside a bit. A sudden twitch from their cock let know know why. Within moments you can feel it pumping it's creamy down your throat, or urethra? It's a strange sensation as even host lets out a surprised sound! However the moment was short lived. With the new cum added to hosts balls he needed to cum more baddly then ever!");
          ...
          "psuckcum": function (character, system, action) {
            transer();
                var sp= character.sandbox.pspecieslist[character.sandbox.splistchoice];
           parer("All that cum you just swallowed suddenly comes shooting back up through you along with a whole load of host's own! The pressure builds up fast and you can't help but notice some of it back flowing down the "+sp+"'s cock! Their balls inflate a bit as the rest comes spewing out from the sides of your mouth!");
        ...
        oper(system, "./wegothrusty", "Feel the pre already flowing up your throat!");
          ...
          "wegothrusty": function (character, system, action) {
            ...
            if(character.sandbox.limits.hasarms){
              ...
              if (character.sandbox.metbefore[character.sandbox.splistchoice][1]) {
                 parer("host begins to thrust you in harder as you hear muffled moans from the other person you are currently exploring! Not that you can see anything, leaving your head just barely inside each time he pulls back. The best you can do is try to reach his balls or or anus to tease him a bit. Eventually even those get trapped by his ass cheeks holding you in place! Your shoulders really prevent any chance of you sinking in deeper dispite host trying his best!");
                
              }else{
                
                 parer("host beings to thrust you in harder as you hear muffled moans from the other person you are currently exploring! Not that you can see anything, leaving your head just barely inside each time he pulls back. The best you can do is try to reach her clit to tease and rub at it but the angle makes that rather difficult. Your shoulders really prevent any chance of you sinking in deeper dispite host trying his best!");
          ...
          "wegocum": function (character, system, action) {
            transer();
            parer("host's balls suddenly clench and you feel the urethra connected to your throat fill with cum as it erupts from your mouth! The senstation is all the more powerfull from your perspective as you pulse and throb in time with the surges of cum! For several moments all you are is a cock doing it's job, delivering cum and supplying your owner with pleasure!");
 system.setQuality("essence",character.qualities.essence+10 );
          ...
          "wegowait": function (character, system, action) {
            transer();
               var sp= character.sandbox.pspecieslist[character.sandbox.splistchoice];
            parer("host and the "+sp+" are left panting after that! host starts to pull you out but due to your unusual shape it doesn't work. He has to tug a few times to finally free you from the tight orafice followed by a flood of cum!");
            parer("Soon after, host cleans you up a bit and then tucks you back away now that he is done with you. Your mind is still in a bit of shock and you can't even focus on what they discuss after that.");
              character.sandbox.erect=false;
     ...
     parer("You hear host talking to someone as he is going about the day, you don't catch exactly what they are talking about but suddenly your body is getting hard! You can feel yourself start to throb as you slide out from his sheath. He gives you a rub but not one of the calm down in there ones. You start to get a good idea of what is going on as you get pressed up against something soft. Along with some awkwardly close groans ! You can't help but feel a bit embaressed like hearing the neighbors having sex through the wall!");
                 ...
                 character.sandbox.tongrnd=rnd(6)-1;
                  ...
                  var tongtype=["You couldn't tell from the face alone but his tongue is clearly feline!","He is clearly an equine with strong tongue and surprisingly roomy mouth!","You only have a few moments to notice his scales before his long thin tongue wraps around you!","You can't quite place his species but you are quickly VERY familiar with their long wide tongue!","From the ears you could tell they were a bunny of some kind.","He looked mostly human but all that means is you are likely heading right down the throat!"];
                  
                  
                  switch (rnd(5)) {
                  case 1:
                    
                    parer("q1Hey there! Bigger than I thought....q1 He says and leans forward kissing you on top of your head! Then followed by a slow suckling as you are pulled into his mouth! "+tongtype[character.sandbox.tongrnd]);
                    
                    
                    break;
                  case 2:
                    parer("q1Don't worry, I have had lots of practice!q1 He says as he leans forward kissing you on top of your head! Then followed by a slow suckling as you are pulled into his mouth! "+tongtype[character.sandbox.tongrnd]);
                    break;
                  case 3:
                    parer("He doesn't say a word as he leans forward kissing you on top of your head! Then followed by a slow suckling as you are pulled into his mouth! "+tongtype[character.sandbox.tongrnd]);
                    break;
                  case 4:
                    parer("There is a terrifying moment as a mouth WIDE open decends over you! Then followed by a slow suckling as you are engulfed by his mouth! "+tongtype[character.sandbox.tongrnd]);
                    break;
                  case 5:
                    if(rnd(2)==1){
                      parer("He grabs onto you and strokes you up and down a few times making sure you are nice and hard! He gives you a long slow lick from the base to the top of your head before slowly sucking you into his mouth! "+tongtype[character.sandbox.tongrnd]);
                      
                    }else{
                      character.sandbox.tongrnd=6;
                       parer("He just snickers and looks up at host q1Ever been with one on my kind before?q1 He asks and opens his mouth. His tongue SUDDENLY shoots out like a projectile smacking into you with a squish! It feels like it is stuck to you!!!! host actually yelps as He pulls it back into his mouth and you along with it! ");
            ...
            character.sandbox.sextype="straight";
                  ...
                  parer("You hear host talking to someone as he is going about the day, you don't catch exactly what they are talking about but suddenly your body is getting hard! You can feel yourself start to throb as you slide out from his sheath. He gives you a rub but not one of the calm down in there ones. You start to get a good idea of what is going on as you get pressed up against something soft. Along with some awkwardly close feminine moans! You can't help but feel a bit embaressed like hearing the neighbors having sex through the wall!");
                  parer("You don't have a chance to feel embarrassed for long before host slides down his zipper and slides you out. Or at least that is who you thought pulled you out....");
                 ...
                 character.sandbox.tongrnd=rnd(6)-1;
                  ...
                  case 5:
                    if(rnd(2)==1){
                      ...
                      character.sandbox.tongrnd=6;
                       parer("She just snickers and looks up at host q1Ever been with one on my kind before?q1 She asks and opens her mouth. Her tongue SUDDENLY shoots out like a projectile smacking into you with a squish! It feels like it is stuck to you!!!! host actually yelps as she pulls it back into her mouth and you along with it! ");
            ...
            switch (character.sandbox.tongrnd) {
             ...
             //normal, normal, normal,
              ...
              case 6: 
                ...
                parer("That sticky tongue just takes the oppertunity to wrap itself more tightly around you! It squeezes and pulls you as if trying to drag you all the way down into their throat... or deeper! The entire concept of being STUCK to a tongue is baffelingly erotic! It just feels so good having something touching you more deeply than any other flesh on flesh contact!");
             ...
             parer("The suction really starts as they slowly pull you from their mouth making your cock flesh feel even harder! They let go with a 'pop' before diving back down for more! It is amost agonizingly good feeling!");
            ...
            system.doLink("./bthrust");
              ...
              "athrust": function (character, system, action) {
                ...
                var thrusty=[
                  ...
                  "You almost find yourself begging to be pushed deeper!",
                 "You feel so hard!",
                 "His ass literally clenches as you bang into his prostate!"
...
//                
//                
            if (character.sandbox.host.cocktype == "knot") {
...
//                }
                ...
                if(character.sandbox.host.cocktype=="knot"){
                  ...
                  //no knotting
                  parer("host suddenly gives one final strong thrust pushing you in as deep as he can! The ass around you suddenly clenches tightly around your lowest part, squeezing you almost possessivly as you press at his prostate. Violating someones ass with your body, it feels so wrong but so good at the same time! You throb overwhelmed with a sudden wave of pleasure as your entire body thickens a bit making it all the tighter! You don't even have time to enjoy it before a torrent of cum suddenly shoots through you!");
                  oper(system, "./pullout", "CUM");
                }
              ...
              "aknotted": function (character, system, action) {
                ...
                if(character.sandbox.reqwater){
                  ...
                  if(character.sandbox.forgotten&&character.sandbox.host.host=="bret"){
                    ...
                    oper(system, "./willwait", ".......","./willwsknot","Start feeling a diffrent kind of pressure");
                  }else{
                    if(character.sandbox.pillroute){
                     oper(system, "./wait", ".......","./wsknot","You feel A diffrent kind of pressure?");
                      
                    }else{
                       oper(system, "./wait", ".......","./strange","Move around a bit enjoying the sensations","./wsknot","You feel A diffrent kind of pressure?");
          ...
          oper(system, "evening/enter", "Get some rest....");
              ...
              "wsknot": function (character, system, action) {
                ...
                parer("Suddenly the urethra runing through your body is forced open by a river of piss! He just couldn't wait.... and all you can do is squirm as he fills the already tight orafice but this time with piss! All you can do is wince as it causes your body to practically shake with the intesity of the stream. It's much more intenst than in the bathroom as he has to fight the pressure too! The pressure alone is overwhelming as it passes through you and out your mouth!");
