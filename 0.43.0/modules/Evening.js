undum.game.evening = {
    ...
    character.sandbox.erect=false;
              ...
              clother();
               ...
               if(character.sandbox.host.host=="bret"&&!character.sandbox.frombook){
                  ...
                  if(character.sandbox.limits.insheath==0||character.sandbox.frombook|| character.sandbox.weekendathome){
  ...
  //                    
                       ...
                       parer("As it approaches late afternoon host starts getting his dinner ready. You are just along for the ride. It's odd not feeling the urge to eat. You havent felt hungry even once since this all started. You do have this weird... full feeling through. It comes from really far below you and it kind of worries you knowing exactly what is down there.");
                ...
                parer("As it approaches late afternoon host starts getting his dinner ready. You are mostly just along for the ride.");
               ...
               system.doLink("./fromdecider");
                    ...
                    system.doLink("./athomeout2");
                               ...
                               parer("As it approaches late afternoon host starts getting his dinner ready. You are mostly just along for the ride. Every now and then you might say something to each other but its pretty basic stuff. As he finally sits down to eat he gives you a look. q1I think having you down there is making me more hungry! I hope you shrink some or I am going to start charging you rent!q1 he says and gets back to his meal. Its odd not feeling the urge to eat. You havent felt hungry even once since this all started. You do have this weird... full feeling through. It comes from really far below you and it kind of worries you knowing exactly what is down there.");
          ...
          parer("host finally arrives back home after the long day. Much longer for you trapped inside his tight sheath all day. He finishes putting his stuff away and settles down.");
              ...
              clother();
                  ...
                  if (character.qualities.harmony >= 60&&character.qualities.ctf>55) {
                    //high or low harmony
                                                        character.sandbox.erect=false;
                character.sandbox.clothed=true;
              clother();
      ...
      oper(system, "./athomeout", "Relax a bit enjoying some open");
                ...
                "stealthroute": function (character, system, action) {
                  ...
                  if(character.sandbox.pillroute){
                   ...
                   oper(system, "./inhappy", "Just accept it an enjoy his warm sheath","./unhappystealth","Squrim around hopeing he notices!");
  ...
  character.sandbox.permanum++;
                    ...
                    if(character.sandbox.harmonyunlockdown&&character.sandbox.harmonyunlockup){
                  ...
                  transer();
                    ...
                    case 1:
                      ...
                      parer("With evening turning into night host heads to bed. He gets fully naked and wraps you and himself up in the warm blankets. You still feel so horny from all the teasing earlier. q1Really starting to think you are better off staying like this.... You feel so good.q1 You hear host mumble as you feel him rubbing you through the blanket! You know he couldn't possibly mean it, he is just teasing.... still it makes you all the harder thinking about it!");
                         ...
                         oper(system, "./npsogood", "Tell him to keep rubbing!","./npresist","Just barlely mumble out a nooo");
                       }else{
                ...
                "enjoyitchange": function (character, system, action) {
                  ...
                  if(character.sandbox.changeofheart||!character.sandbox.enjoyit){
                    ...
                    if(character.sandbox.enjoyit) {
                      ...
                      parer("You really think hard about things and the more you ponder the more embarrassing it is. All the time as hosts cock must have been getting to you! Maybe it was some sort of stolkholm syndrom. How were you enjoying it that much? The thought of it makes you even more uncomfortable. You almost want to just hide in a sheath all day and not think about it any more..... Wait.....");
                   ...
                   if(character.sandbox.ws){
                    ...
                    parer("You have been embarassed and distressed with your life as a cock for "+character.qualities.day+"'s. Maybe it hasn't been all that bad....");
                          ...
                          //Very good! Such a good cock. Give me a nice throb and I might let you out to play more often.
                           ...
                           if(character.sandbox.limits.insheath==0){
                             ...
                             //In sheath!
                               ...
                               parer("q1Oh is my poor cock stuck in it's sheath again?q1 He says giving you a few rubs to help you extend out of it. q1That's a good cock, now stay nice and hard so I can clean you.q1 He says giving you good rub down with soap before his sheat decides you been out too long and starts pulling you back inside!");
                ...
                "postmirror": function (character, system, action) {
                  ...
                  if(character.sandbox.limits.insheath==2) {
                    ...
                    if(character.sandbox.enjoyit){
                       ...
                       parer("Being trapped in his sheath makes it a bit hard to see yourself. With just your head sticking out all you can see is the clear shape your body makes stuffed into the tight sheath. host is just standing in front of it checking over his fur for any tangles as he dries off. Meanwhile you are more focused on your home between his legs. You are really happy to call his sheath home, its warm moist insides always feel so good against your sensitive body.");
                    }else{
                       parer("Being trapped in his sheath makes it a bit hard to see yourself. With just your head sticking out all you can see is the embarrassingly clear shape you make stuffed into the tight sheath. host is just standing in front of it checking over his fur for any tangles as he dries off. Meanwhile you are more focused on your home between his legs. It's so embarrassing to see it from the outside and knowing you are trapped inside that sheath!");
  ...
  //              }, //function close
     ...
     system.doLink("./permamenu");
                ...
                "permamenu": function (character, system, action) {
                    ...
                    if(character.sandbox.limits.cantalk) {
                       oper(system, "./sogood", "Tell him to keep rubbing!","./resisturge","Barlely mumble out a nooo","./moan","Just moan");
                        ...
                        if(character.qualities.essence>= character.sandbox.ttcost){
                           ...
                           oper(system, "./sogoodtt", "(TT:"+ character.sandbox.ttcost+") Tell him to keep rubbing!","./resisturgett","(TT"+ character.sandbox.ttcost+") Barlely get out a nooo","./throb","Just throb");
                ...
                "throb": function (character, system, action) {
                  ...
                  parer("You have never been left on such a cliff like this before! For a moment you are terrified of experiencing blueballs for the first time! He can't just leave you hanging like this! Soooo close! He was talking about.... something but it wasn't important you just need him to keep going!");
