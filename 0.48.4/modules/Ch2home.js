...
//            }
          ...
          "dreams": function (character, system, action) {
            ...
            character.sandbox.saveloc="ch2home/dreams";
        ...
        "playnone": function (character, system, action) {
                ...
                parer("You desperately try to rub your cock, but even though you are rock hard it just isn't enough! You are desperate to cum and exhausted from the effort. You ass meanwhile is practically pulsating as it seems to clench on its own at times. You need, NEEED somone to give your desperate ass a good humping! But you know what that would do... How it would feel. How safe it would make you feel. How complete you would be back between a strong pair of legs.... You have to shake your head when you notice where that train of thought was going!");
            ...
            oper(system,"./mtease", "Clean up... and get ready for the day...");
              ...
              "milker2": function (character, system, action) {
                ...
                parer("It really feels good and for the first time in a while you can ignore the desperate need to feel something in your ass! All of your attention is focused on the machine literally milking your cock like you were just a cow for giving milk! The idea of being an actual udder as a milking machine passes through your mind just as you feel the orgasm speep over you! You have to desperately fumble for the off switch as the machine just keeps going even after it finishes sucking away all of your cum!");
                 ...
                 parer("It's a tad embarrassing as you almost feel jelous that your cock got to go inside but you can't. You really need to make sure your next owner has one of these!");
       ...
       transer();
          ...
          "callpasthost": function (character, system, action) {
            ...
            parer("Your fingers tremble a bit as you dial the number and hear it ringing. You hear him pick up q1Hello?q1");
                       ...
                       var nh= character.nh["mark"];
                character.sandbox.currenthostparse=nh.parse;
                            character.sandbox.host = character.nh["mark"];
                character.host=character.nh["mark"];
