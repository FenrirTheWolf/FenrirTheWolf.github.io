...
//                
          ...
          "sleep": function (character, system, action) {
            ...
            if(character.sandbox.tavernshortcut){
                    ...
                    clother();
                     parer("A few hours later you start waking up to a strange feeling in your rear. As you try to move a sudden surge of pleasure shoots through you! ");
                     
              parer(" Looking around you realize.... THERE IS SOMEONE SLEEPING WITH YOU! You vaguely remember a name... host? He must have hooked up with you while you were drunk!! All you can do is wiggle around and try to disentangle yourself from him but it becomes clearer and clearer that you can't...");
                parer("You look down and see... nothing. Well you see his sheath. And... Quickly you discover your arms are already gone! Your entire body is already finished changing fully into some RANDOM STRANGER'S COCK! All you can do is wiggle and struggle as you get slowly pulled into his sheath as you hear him yawn!");
                
//                       if(character.qualities.lust>60){
//              }else{
//                       parer("A few hours later you start waking up to a strange feeling in your rear. As you try to move a sudden surge of pleasure shoots through your ass! ");
//              parer(" Looking around you realize.... THERE IS SOMEONE SLEEPING WITH YOU! Their cock is deep inside your rear! You vaguely remember a name... host? He must have gotten hard again in the night! All you can do is wiggle around and try to disentangle yourself from him but it becomes clearer and clearer that you can't dislodge his cock by yourself.... It's already too late! <p>It is happening again.... You know all to well what is about to occur");
//                
//                
//              }
//          
                  ...
                  try {
                       if(!character.host.genderismale){
              
                     parer("A few hours later you start waking up to a strange feeling in your rear. As you try to move a sudden surge of pleasure shoots through your ass! Looking around you realize host is still behind you! Even through if feels like your cock is still stuck inside her... you also feel something in your ass... or connected to your ass? All you can do is wiggle around and try to disentangle yourself from her but it becomes clearer and clearer that you can't.... <p>It is happening again.... You know all to well what is about to occur.");
            }else{
...
you know what you want
            ...
            clother();
            if(character.sandbox.tavernshortcut){
                  oper(system, "./tavernmorning", "You hardly even remember who this is!!!!");
            }else{
        ...
        if(character.host.genderismale==false){
            ...
            if(character.sandbox.ch2re){
              ...
              if(character.host.genderismale==false){
                ...
                if(character.sandbox.internalballs){
                     parer("Once again you wake up, the sun starting to shine through the window just a bit. Even better you don't feel host's cock\
                                keeping you prisoner like earlier. With a sigh you move around but are stopped rather abruptly as your waist seems stuck in place. You have lost all sensation from your legs sort of. In a way you can still feel them but it's embaressingly mixed up with the sensation from your b#alls! They are hidden away though deep below now, in a way she has effectivly stolen yours! Trying to flex them shockingly causes HER balls to tighten. You tug a few more times knowing exactly what is happening. Just like before... your fate is already sealed. ");
                  
                }else{
                     parer("Once again you wake up, the sun starting to shine through the window just a bit. Even better you don't feel host's cock\
                                keeping you prisoner like earlier. With a sigh you move around but are stopped rather abruptly as your waist seems stuck in place. Looking down you see the massive shape of host's NEW balls, but surprisingly not your legs. In a weird way you feel like that is your sack that he effectively stole! Trying to flex them shockingly causes HER balls to pull up slightly in his sack. You tug a few more times knowing exactly what is happening. Just like before... your fate is already sealed. ");
                 ...
                 if(character.sandbox.internalballs){
                  parer("Once again you wake up, the sun starting to shine through the window just a bit. Even better you don't feel host's cock\
                                keeping you prisoner like earlier. With a sigh you move around but are stopped rather abruptly as your waist seems stuck in place. Looking down you don't see them, but you can almost feel hosts balls. Strangely it seems to be coming from what you once considered your legs. Trying to flex them shockingly causes his balls to tighten from deep below you. You tug a few more times and realize exactly what is happening. Just like before... your fate is already sealed. ");
          ...
          "dreamer": function (character, system, action) {
            ...
            parer("Eventually you both cum, already connected to the point you can feel host's orgasm! Your stomach bloats and feels full once he finishes as if from a large meal. Instinctively you open your mouth but nothing comes out... yet. <p>It almost feels like cum is traveling UP your cock and ass at the same time...  and into your belly! Soon all feeling of the cock being yours is gone as you seem to meld fully into his crotch. ");
              if(character.sandbox.internalballs){
                
                
              }else{
                parer("Reaching farther down reveals the start of host's balls, your balls.....");
          ...
          "full": function (character, system, action) {
            ...
            parer("host seems to make the decision for you though as he reaches down to rub your body! A thrill runs through you as for the first time he starts treating you like a cock. It's like a first kiss.... Falling in love for the first time... The first time host treats you like his own cock!");
              ...
              "tavernmorning": function (character, system, action) {
                transer();
                //nothing has been said yet we are at a clean slate for the tavern path
                character.sandbox.tavernshortcut=false;
           
                   
                   //150th follower! Dusk gets a cockie!
                   if(!character.sandbox.girl){
                             parer("Things are already so much farther along then you ever intended them to get! host just seems to mumble and stumbles out of the bed. q1What a hangover....q1 They say and quickly cover you up in a layer of clothing without so much as even looking at you. YOU DON'T EVEN KNOW WHAT THEY LOOK LIKE!!!!");
                      parer("They rather stumble out of the tavern. The dragon tending the bar calls out q1Hope you had a fun night!q1 He says completely oblivious to host's new stowaway.");
                   
                   parer("They manage to make it home and lay down in their real bed as they try to get through the rest of their hangover. As they lay in bed, the pants finally come off freeing you from the cloth prison!");
                   
                   
                   }else{
                     
                     parer(character.host.wake100);
                     parer("host worried q1What a hangover!... Maybe I am dreaming.... Still.. q1 They say and quickly cover you up in a layer of clothing without so much as even looking at you. YOU DON'T EVEN KNOW WHAT THEY LOOK LIKE!!!!");
                      parer("They manage to make it home and lay down in their real bed as they try to sleep through this 'dream'. As they lay in bed, the pants finally come off freeing you from the cloth prison!");
                   }
                  
                   
                oper(system, "nhstealth/rub", "Throb hopefully!");
...
"rub": function (character, system, action) {
            ...
            if(character.sandbox.girl=="herm"){
              parer("SHI DOESN'T REALIZE YOU ARE THERE!");
              
            }else if (character.sandbox.girl){
              parer("SHE DOESN'T REALIZE YOU ARE THERE!");
            ...
            oper(system, "./resist", "Try to get his attention", "./accept", "Try to stay hidden");
          }, //function close
...
parer("You can feel that deeper connection even better now. Something is different this time with the transformation. You can feel deeper into his body than before, his balls and bladder are nearly as easy to feel as the rest of you. You are trulely and completely a part of his body this time. Maybe you really are just his cock now...");       
   ...
   parer("You are so lost in the sensations that it's hard to deny it. Especially after just getting back to feeling normal again. You throb once... You can't just make that decision just yet.");
        ...
        if(character.sandbox.ws){
          ...
          oper(system, "./piss", "Prepare yourself");
        }else{
                  system.doLink("./nope");
      ...
      "", {
        ...
        actions: {
          ...
          "asktostay": function (character, system, action) {
            ...
            character.sandbox.clothed=true;
            clother();
              parer("Being seperated from him felt so wrong, maybe you really have been his penis the entire time. The idea of unmering again seems just wrong now. Maybe you don't want him to let you change your mind, right now you realize what is best for you. Hesitantly, you ask him about it...");
...
//           
    ...
    newhostexplain: new undum.SimpleSituation(
        ...
        transer();
            ...
            parer("You come clean about everything..... From the ring to the period of time you spent as someones else's cock! You knew this might happen again but you just couldn't stop yourself. The feelings of need, and... maybe wanting this to happen again.");
