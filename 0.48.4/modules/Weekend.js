              ...
              "lovefeel": function (character, system, action) {
               ...
               if (character.sandbox.ws&&false) {
                    ...
                    parer([ pre+"It might be a bit obvious but being his cock feels amazingly good! Every sensation your body feels is wired directly for pleasure! Even when you are not being used... You can just relax in his sheath.... ",
                      ...
                      pre+ "It isn't just the cumming part that feels good, it's everything about being a cock! Your whole body feels softer and just more comfortable like this. And every inch of your skin sends tingles of plreasure through your body!",
         ...
         var pre= character.sandbox.wpre;
              ...
              "usedlike": function (character, system, action) {
                transer();
                    ...
                    parer([ pre+ "The most humiliating part is being used like a penis! It's also sort of the best part too. It just makes it so confusing and embarrassing. Your body being turned into a thing to rub and stroke for someone else's pleasure! Private fun time means getting rubbed and stroked till you are rendered immobile and drooling cum from your mouth!",
           ...
           system.doLink("./talkendemb");
              ...
              pre+   "Every night you spend inside his sheath reinforces how perfectly suited you are to being a cock! No one should be able to adjust to this life so quickly, yet it almost seems like you are made for it. You were always meant to become a penis, just a slab of meat purely for somone else's pleasure! The most embarrassing part is how good thinking about that feels!"]);
                       system.doLink("./talkendemb");
              }, //function close
              ...
              "justthrob": function (character, system, action) {
                ...
                if(character.sandbox.ignore){
                  ...
                  parer(["You don't respond in any way other than to simply throb in his pants. Thats all a penis is expected to do after all. It's just eaiser this way all comfortable inside his pants really trying to embrace what you have become.",
                    ...
                    "You don't really pay attention to his question, you are just a part of his body. You feel yourself throb slightly in response, the only thing you would expect a cock to do. Cocks don't talk after all... It is so much easier to just accept what you are and let him make all the important decisions for you.",
              ...
              "throbend": function (character, system, action) {
                ...
                if (character.sandbox.ignore) {
                    ...
                    parer(["host just snickers at your lack of a response and gives you a rub through his clothing. He doesn't say anything more knowing thats exactly the way you want it. He goes back to what he was doing without giving you even a bit off attention just like he would if you were a normal part of his body.",
                      ...
                      "q1Perfect answer... Just keep acting like that and everything will be perfectq1 He says causing you to throb again, this time him doing it..."]);
     ...
     default:
              ...
              "talkendlove": function (character, system, action) {
                ...
                if(!character.sandbox.perma){
                   ...
                   parer(["q1Heh, you are really enjoying this more than I thought you would.q1",
