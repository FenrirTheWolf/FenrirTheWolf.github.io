 ...
 */
 ...
 undum.game.version = "0.49";
 var patchversion = ".1";
 //document.getElementById("versionnum").innerHTML ="v"+undum.game.version+patchversion;
 
 document.getElementById("versionnum").innerHTML = "0.49" + patchversion;
 ...
 //Maybe ad a struggle mechanic.
   ...
   requestmatrix: new undum.SimpleSituation(
    //heading:"Inside a sheath"
    "<h1><p class=transient>Choose a question</p><h1>",
    {
      displayOrder: 4,
      choices: "#choice",
  ...
  oper(system, "preworksender/prework", "Let him continue getting ready");
   ...
   findring: new undum.SimpleSituation(
    "",
    {
      ...
      canView:
       function (character, system, host) {
         return ((character.sandbox.ringlost || character.sandbox.ringreallylost) && (character.sandbox.ringgone == false)&&!character.sandbox.ringatpawn&&!character.sandbox.perma&&!character.sandbox.ringhelp);
