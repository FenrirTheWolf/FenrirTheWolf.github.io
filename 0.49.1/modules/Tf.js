...
//                    }
            ...
            if(character.sandbox.ctfrole=="bodypart") {
             ...
             if(character.qualities.harmony>=87&&(!character.sandbox.blinkyactivated)){
              ...
              if((character.sandbox.gooutcount>10)){
              ...
              character.sandbox.tfed = false;
                 ...
                 character.sandbox.tracksleep++;
                    ...
                    if (character.sandbox.ring&&(!character.sandbox.perma)&&!character.sandbox.ringgone){
                     
                 if(character.sandbox.fullcock>3&&!character.sandbox.ringcheck&&character.sandbox.runedo.stability){
                   system.doLink("./stuck");
                 ...
                 // system.doLink("./hostcontro");
                    ...
                    if (character.sandbox.control){ //This means they have used the thoughts rune. No book needed
                ...
                //push for control, End the dreamstate, 
                    ...
                    if(character.qualities.essence>100){
...
//                    
               ...
               character.sandbox.tracksleep++;
                  if(character.sandbox.tracksleep>3){
                  character.sandbox.tracksleep=3;
                };
                    if(character.sandbox.tracksleep<-3){
                  character.sandbox.tracksleep=-3;
                };
            ...
            actions: {
              "controlrune": function (character, system, action) {
                ...
                oper(system, "./controlrune2", "Focus on the runes...","./stop","Disperse the dream","./hostcontrosleepcheck","Just go to sleep");
          
              }, //function close
              "hostcontrosleepcheck": function (character, system, action) {
          character.sandbox.tracksleep++;
                system.doLink("./hostcontro");
              }, //function close
     ...
     if(character.qualities.essence>10){
           system.setQuality("essence",character.qualities.essence-10);
            ...
            if(character.qualities.essence>20){
              ...
              oper(system, "./low", "(5)Use some and hope for the best","./mid","(10)Match his own","./high","(20)Use a massive amount!");
 ...
 delay(["You struggle for control!","Slowly you manage to regain your focus",totype]);
           ...
           if(character.sandbox.dreamscape){
             ...
             delay(["You easily take control of the dreamstate!","./newcontrol"]);
           }else{
             delay(["You easily take control of the dreamstate!","./controlsuccess"]);
              ...
              "controlrune2": function (character, system, action) {
                ...
                if(character.qualities.essence>60||character.sandbox.ch2re||character.sandbox.trackruneobey<-4){
                      character.sandbox.trackruneobey=0;
              ...
              "runeactions": function (character, system, action) {
                ...
                switch (character.sandbox.activerune) {
                  ...
                  if(character.sandbox.host.host=="will"||((character.sandbox.cocktype=="knot"||character.sandbox.cocktype=="canine")&&character.sandbox.host.cocktype==character.sandbox.cocktype)){
                    
                      runeaction="You try to access the rune but it almost feels stuck. You can't seem to affect it at all.";
                  }else{
                    if( character.sandbox.cocktype=="canine"){
                          character.sandbox.cocktype=character.sandbox.host.cocktype;
                   runeaction="You activate the rune and feel your shape starting to chage, less thickness around your base!!";
                    }else{
                        
                      if(character.qualities.ctf>=95){
                        //character.sandbox.morninginter="./intercanine";
                        character.sandbox.cocktype="canine";
                   runeaction="You activate the rune and feel.... a strange swelling around your base. It's strange almost like it's waiting to feel a tight grip around it!";
                      }else{
               ...
               if(character.sandbox.host.host=="will"||(character.sandbox.host.cocktype=="reptile"&&character.sandbox.cocktype==character.sandbox.host.cocktype)){
                    
                      runeaction="You try to access the rune but it almost feels stuck. You can't seem to affect it at all.";
                  }else{
                    if( character.sandbox.cocktype=="reptile"){
                          character.sandbox.cocktype=character.sandbox.host.cocktype;
                   runeaction="You activate the rune and feel a great deal of thickness return to your form, though your mobility seems to lessen.";
                    }else{
                        
                      if(character.qualities.ctf>=95){
                        //character.sandbox.morninginter="./interreptile";
                        character.sandbox.cocktype="reptile";
                   runeaction="You activate the rune and feel far more thin, narrower at the tip especially! It's like your entire body tapers into a sleek tentacle. You even feel a bit more mobile and almost prehensile!";
                      }else{
               ...
               if(character.sandbox.host.host=="will"||(character.sandbox.cocktype=="feline"&&character.sandbox.cocktype==character.sandbox.host.cocktype)){
                    
                      runeaction="You try to access the rune but it almost feels stuck. You can't seem to affect it at all.";
                  }else{
                    if( character.sandbox.cocktype=="feline"){
                          character.sandbox.cocktype=character.sandbox.host.cocktype;
                   runeaction="You activate the rune and feel smoother, like all the bumps and nubs along your body have disappeared.";
                    }else{
                        
                      if(character.qualities.ctf>=95){
                        //character.sandbox.morninginter="./interfeline";
                        character.sandbox.cocktype="feline";
                   runeaction="You activate the rune and feel yourself change slightly, your normally uniform shape seems to grow numbs and details. Though you may have the shape of a feline cock, anthro felines have only a hint of those nub like structures.";
                      }else{
                 ...
                 if(character.sandbox.host.host=="will"||(character.sandbox.cocktype=="horse"&&character.sandbox.host.cocktype==character.sandbox.cocktype)){
                    
                      runeaction="You try to access the rune but it almost feels stuck on. You can't seem to affect it at all.";
                  }else{
                    if( character.sandbox.cocktype=="horse"){
                          character.sandbox.cocktype=character.sandbox.host.cocktype;
                   ...
                   runeaction="You activate the rune and feel.... SO MUCH MORE POWERFUL! If you every become a full cock with this active you will be as strong as a stallion!";
                      }else{
                  ...
                  case "breaking":
                    ...
                    if(character.sandbox.runedo.thoughts){
                      character.sandbox.runedo.thoughts=false;
                       runeaction="You feel the connection to host's mind suddenly close off! You are all by yourself now just attached to his body. Nothing you do seems to be able to reach him no matter how much essence you pour into it!";
                    }else{
                       character.sandbox.runedo.thoughts=true;
                      runeaction="You feel the connection to host's mind slowly start to return! The distant tingles in the back of your mind are there once again. By tapping into that stored essence you feel like you could talk to host in his head just by focusing.";
                    }
                  ...
                  case "fullmerge":
                    dl = "morning/preenter";
                    runeaction = "The arcane matrix within the ring begins to vibrate a little, and then suddenly vibrate faster. You look down at yourself and witness how your body hastily merges with host, appearing as their cock, but only a little larger.";
                    system.setQuality("ctf", character.qualities.ctf + 100);
                    system.setQuality("harmony", character.qualities.harmony + 100);
                    character.qualities.harmony = 100;
                    break;
                  case "revert":
                    dl = "morning/preenter";
                    runeaction = "The arcane matrix within the ring begins to vibrate a little, and then suddenly vibrate faster. You look down at yourself and witness how your body hastily unmerges with host, turning back into what seems to be your body.";
...
newtest = Math.floor(ctfnumnew / 20) * 20;
  ...
  if(character.sandbox.ignore){
                        ...
                        if(character.sandbox.host.plantokeep){
                           character.sandbox.tfresponse = "host gives you a poke, q1Hummm, don't think just because you got your arms back that you are any less MINE. You are right where you belong!q1 He warns.";
                          
                        }else{
                           character.sandbox.tfresponse = "host gives you a poke, q1Got your arms back I see! We must be doing something right to turn you back! No rubbing me in public thoughq1 He warns.";
...
//// (character.sandbox.tfup) ? "It is a bit of a shock as you discover that you no longer have arms! They seem to have been absorbed into your sides and to make it worse you discover your mouth has been completely taken over by host's urethra, you can still taste in it but find yourself unable to speak. In fact your entire head has shifted slightly to resemble a cock's head. Your eyes are still intact and some of your facial structure.":
              ...
              "esnope": function (character, system, action) {
                ...
                if(character.sandbox.internalballs){
                    ...
                    parer("For the first time you are fully awake and able to watch as the transformation takes place! You can actually see the runes glowing on your body like strange tattoos! There is also a very faint glow from your legs that are trying to change.... The flesh doesn't move or morph like you might expect. It is much more eerie than that! It's like everytime you blink you see something is different! The glow sort of hurts to look at for too long causing you to blink and find more changes! In this case it's you legs starting to get pulled back into his slit!");
                }else{
            ...
            parer("You try to pull harder causing host to grumble in his sleep. You also get the weirdest sensation in your throat! Its like his uretha is pulling all the way through your body where it has connected to your throat! The feeling is unerving but you keep pulling! ");
                 if(character.sandbox.internalballs){
                  
             parer("For the first time you are fully awake and able to watch as the transformation takes place! You can actually see the runes glowing on your body like strange tattoos! There is also a very faint glow from your legs that are trying to change.... The flesh doesn't move or morph like you might expect.... It is much more eerie than that! It's like everytime you blink you see something is different! The glow sort of hurts to look at for too long causing you to blink and find more changes! In this case it's your legs starting to slip free from his slit!!");
           }else{
...
//                   
              ...
              "control": function (character, system, action) {
                ...
                if (rnddream < character.sandbox.host.harmony[character.sandbox.htarget]) {
                  ...
                  //
                  character.sandbox.pchoice=true;
                  oper(system, "./tfreversion", "Reversing the transformation", "morning/preenter", "Preventing further changes", "./tfup", "Becoming a cock");
...
//                override=(rnd()>2); //chance the host will just TF them more anyway
              ...
              if(character.sandbox.ignore){
                ...
                character.sandbox.tfresponse ="host looks down at you and blinks a few times. q1Huh, You look a good bit bigger than last night, you might be able to get back to normal after all if you keep this up!q1 he says with a sense of encouragement. ";
                }
              ...
              "tf80": function (character, system, action) {
                ...
                character.sandbox.tfresponse = ((character.sandbox.tfup)?( "After noticing the changes host gives you a reassuring rub \"If this keeps up there won't be any way to tell you apart from a normal cock\" he says with concern") :("host notices the changes to your body and gives you a pleasent rub. q1So it really isn't permanent, see? No need to worry at all!q1"));
                  if(character.sandbox.ignore){
              ...
              "tf100": function (character, system, action) {
                ...
                character.sandbox.tfresponse = "host looks down noticing the changes and gives you a slight rub. q1Looks like you are fully transformed now, can you even move?q1 You quickly wiggle around some to prove you are still alive and aware down here. q1Well... at least you can't change any further into my cock.q1 He says.";
                  if(character.sandbox.ignore){
