                    ...
                    try{
                        ...
                        if(character.sandbox.holdem){
                            ...
                            for (x2 in character.sandbox.newhostnames) {
                                ...
                                if (typeof loclist === "string" && !fulllist.includes(loclist) && !newhostlocations.hasOwnProperty(loclist[x2])) {
                                    fulllist.push(loclist);
                                } else if (Array.isArray(loclist)){
                                    for (x2 in loclist){
                                        if (typeof loclist[x2] === "string" && !newhostlocations.hasOwnProperty(loclist[x2])) {
                            ...
                            //         var index = fulllist.indexOf(fulllist[x2]);
                            //         fulllist.splice(index, 1);
                            //     }
                            //     if (!newhostlocations.hasOwnProperty(fulllist[x2])) {
                            //         newhostlocations[fulllist[x2]] = [];
                            //         //avplaces.push(fulllist[x2])
                            //         console.log("Found a new location: '" + fulllist[x2] + "'");
                            //         if (fulllist.length === 1) {
                            //             console.log("Location added. (" + fulllist[x2] + ")");
                            //         } else if (fulllist.length > 1) {
                            //             console.log("Locations added. (" + fulllist + ")");
                            //         }
                            //     }
                            // }
                            var totalplaces = function(){
                                if (fulllist.length === 1) {
                                    console.log("Location added: (" + fulllist[1] + ")");
                                } else {
                                    console.log("Locations added: (" + fulllist + ")");
                                }
                            }
