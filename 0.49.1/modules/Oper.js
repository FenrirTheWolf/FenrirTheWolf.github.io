function oper(system, href, text, href2, text2, href3, text3) {
  if (!href && !href2 && !href3) {
    ...
    //OPER DIAPER ADDON
    system2 = system;
   var character2 = globalaccesscharacter;
...
/////////////////////////////////////////////////////////////////////////////////////////
  ...
  girlyfier= function(texty){
    ...
    var girlifier2=[
     ...
     for (let nx in girlifier2) {

// console.log("parer check " +character.sandbox.currenthostparse[x] );

    texty = texty.replace(new RegExp(girlifier2[nx][1], 'g'),girlifier2[nx][0]);
...
return texty;
   ...
   hosterry=  function(texty){
       
       
       texty = texty.replace(new RegExp("host", 'g'),character2.sandbox.pasthost);
       return texty;
     };
     
     
         if(text)text=hosterry(text);
    if(text2)text2=hosterry(text2);
    if(text3)text3=hosterry(text3);
