...
function clother2(character, system, x) {
 ...
 console.log("cocktype1 is" + character.sandbox.cocktype);
  if(character.sandbox.cocktype==""||character.sandbox.cocktype==undefined&&character.qualities.ctf>19){
...
//            cssreset=false;
           ...
           if(!character.sandbox.erect){
            ...
            yport.t5.className="xeyportait5";
               ...
               //  yport.t5.className="xeyportait5";
                   ...
                   yport.t4.className="xeyportait4peek";
            yport.t5.className="xeyportait4peek2";
               yport.t4.src=ref+img["tippeek3"];
            yport.t5.src=ref+img["sheathpeek3"];   
 ...
 yport.t4.className="xeyportait4";
  ...
  if( character.sandbox.clothed&&clothingenabler&&!character.sandbox.erect&&(name!="lizard"||hostclothingtype=="r")){
    ...
    console.log("is ring active? " +character.sandbox.ring );
  if(character.sandbox.erect&&cocktyper=="canine"&&character.sandbox.ring&&character.sandbox.runedo.stability&&character.qualities.ctf==100){
       yport.t8.src=ref+img["cring"];
      yport.t8.className="xeyportait5";
    
  }else{
           yport.t8.src="";
      yport.t8.className="xeyport";
  }
