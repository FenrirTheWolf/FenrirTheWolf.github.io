    ...
    oper(system, "./athomeout", "Relax a bit enjoying some open");
              ...
              switch (rnd(4)) {
                  ...
                  case 3:
                    ...
                    break;
                  case 4:
                    parer("He doesn't stay sitting for long and eventually gets up. What follows is a loud BRRR noise. When that stops you hear dishes clinking about. Just regular house cleaning things that everyone has to do. Something he really doesn't need his cock to be involved in. Not to mention you would probably make more of a mess drooling cum that he would have to clean up.");
                    break;
...
//                      } else {
              ...
              "prebegforit": function (character, system, action) {
                ...
                parer("You already said yes to being his cock, and accepting it. The ring is probably gone for good so you might as well keep host as happy as you can. What is a little promise if it will satisfy him for now. You already were considering your life as just a happy cock... Whats so bad about a little promise.");
               ...
               switch (character.sandbox.ctfrole) {
                      ...
                      case "petpenis":
                        //Very good! Such a good cock. Give me a nice throb and I might let you out to play more often.
                         parer("host heads to the shower, this is always a nice time between you and him. He slathers up his body under the warm steaming water. He of course doesn't waste this opportunity to tease and play with you a bit.");
              ...
              "postmirror": function (character, system, action) {
                ...
                if(character.sandbox.limits.insheath==2) {
                  ...
                  if(character.sandbox.limits.hasarms){
                    ...
                    parer("You are thankfully not contained in a sheath, your body is just to big and long for that. For the most part you look a bit smaller than you should but otherwise appear normal from the.... sheath up. Your arms and head are untouched by the transformation.");
                    ...
                    //Looks like a cock with a slit for a mouth
                       parer("You are thankfully not contained in a sheath, your body is just to big and long for that. Your head and arms are gone leaving you looking like a slightly humanoid shaped cock. Anyone seeing you would instantly think you were a person stuck halfway between becoming a cock. Even you head resembles that of a penis now, complete with vertical slit for a mouth!");
   ...
   system.doLink("./permamenu");
          ...
          parer("He seems to be saying something important, but all you can do is moan as teases your body! Your entire body is hard, throbbing, pulsing as the pressure in the balls below you builds... Then he stops!");
              ...
              "acceptcock": function (character, system, action) {
                ...
                if(character.sandbox.enjoyit){
                  parer("Your mind is so lost in deseperation that all you can think is that he is right. He has used you to cum with over and over. It's all you are good for and with the ring gone that won't be changing. This is what you wanted, being his cock has been the best experience. You tell him you are just a part of his body, all you will ever be is his cock...... His desperate needy cock that just wants to cum already!");
                   system.setQuality("dignitylost",70);
                }else{
                  
                   parer("Your mind is so lost in deseperation that all you can think is that he is right. He has used you to cum with over and over. It's all you are good for and with the ring gone that won't be changing. You didn't want this but it's no late now to denie it. You tell him you have come to terms with it, you are his cock. A penis is all that you are now to him.");
    ...
    character.sandbox.ring=false;
             ...
             parer("You quickly remind them about the ring before they fall asleep. ");
              ...
              "ringonoroff2": function (character, system, action) {
                ...
                if((rnd()+character.sandbox.xeyischeating)>character.sandbox.tracksleep||character.sandbox.didresearch){
...
//              }
              ...
              "ringend": function (character, system, action) {
                ...
                if(character.sandbox.ring&&character.sandbox.controlruneaccess&&rnd()>7&&!character.sandbox.stealth&&!character.sandbox.perma){
