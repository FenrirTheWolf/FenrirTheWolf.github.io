...
//               if(character.sandbox.host.host=="dari"&&character.qualities.harmony>60){
//            
...
//               }
            ...
            actions: {
              "preenter": function (character, system, action) {
                ...
                character.sandbox.saveloc="morning/preenter";
                
                if((character.sandbox.hostaskedfor!="")&&character.sandbox.activerune!=character.sandbox.hostaskedfor){
                  character.sandbox.trackruneobey--;
              ...
              if(character.sandbox.skipto){
                  ...
                  character.sandbox.skipto=false;
                ...
                switch(character.sandbox.mind){
                  ...
                  case 3:
                  mindlist.unshift("Probably not. Unless he decides to name you some day...");
                  case 2:
              ...
              "debugm": function (character, system, action) {
               ...
               "forgottencock": function (character, system, action) {
                ...
                if(character.sandbox.tookpill){
                  ...
                  parer("It's morning again. You feel so soft and squishy inside host's sheath. It has been days since you were this lucid. Cocks can't move, only host can make you throb or twitch. He hasn't taken the pill in a few days so some of your mind is coming back but not your ability to move. It feels so strange knowing you have just been living inside his sheath for days as a real cock. You can still sort of remember it...");
...
if(!character.sandbox.forgotten){
  ...
  character.sandbox.morningvar="aroused";
                      parer(["You wake up surrounded by cloth in complete darkness, along with a mumbling sound from above you. Your entire body feels warm and hard, enough so you find it even more difficult to move around. host apparently is going to wake up with morning wood.",
                        "You feel so hard and stiff as you start to wake up, like a pressure all through your sensitive body. host is mumbling softly above you in his sleep. You can easily feel how horny he is going to be waking up this morning.",
                        "The morning brings a sensitive thrill through your whole body as host almost humps you against the blankets, your body is hard and stiff from a serious morning erection!"]);
                  ...
                  if(character.sandbox.forgotten){
                    ...
                    parer(["You wake up in the warmth of host's sheath. You can't see anything due to the sheath completely covering your head. host's musky scent overwhelms you, seems you even sweat like a cock. Especially since you have been stuck inside his sheath all night.","It is so warm and snug inside hosts sheath. The musky scent is overwhelming, you are literally sweating it out as a normal cock would! You can't see anything due to the sheath completely covering your head.","A warm wet feeling greets you opon waking up, the sheath around you is so tight and moist with the musky sweat your body now produces. You can't even see open air with his sheath covering you up"]);
                ...
                switch (character.sandbox.limits.insheath) {
                  case 0:
                    ...
                    if(character.sandbox.internalballs){
                             parer(["You wake up feeling rather comfortable, head on a pillow and host's #alt wraped around you as one would a lover. You then blush deeply remembering you are attached to his groin. From the snoring you can assume host is still fast asleep","You wake up with host holding you close almost like a teddy bear or treasured possession. At first it almost seems odd how large he is compared to you till you feel him twitch in his sleep sending a throb through your body! Quickly reminding you of your position as a new part of his body...","You eventually open your eyes as morning greets you, host has you cuddled close. You can't help but feel a bit aroused as he sometimes rubs you a bit in his sleep. The rest of your body is just missing, excepct for the telltale sensations from his internal b#alls, even now you can feel them churning with cum."]);
                      ...
                      if(character.sandbox.internalballs){
                        ...
                        ballfixy=" Even if he wasn't holding you so tight, your legs have been repurposed to function as his balls. Even now you can feel them churning with cum.";
                      }else{
                            
                        ballfixy=" Even if he wasn't holding you so tight, your legs are nothing but a massive sack with host's balls inside. Even now you can feel them churning with cum.";
                      }
                         if(character.sandbox.enjoyit){
                      
                         parer(["You wake up feeling rather comfortable, head on a pillow and host's #alt wraped around you as one would a lover. You then blush deeply remembering you are attached to his groin and your legs have basically merged with his massive balls. From the snoring you can assume host is still fast asleep","You wake up with host holding you close almost like a teddy bear or treasured possession. At first it almost seems odd how large he is compared to you till you feel him twitch in his sleep sending a throb through your body! Quickly reminding you of your position as a new part of his body...","You eventually open your eyes as morning greets you, host has you cuddled close. You can't help but feel a bit aroused as he somtimes rubs you a bit in his sleep."+ballfixy]);
                    }else{
                      
                    
                        
                        parer(["You wake up feeling rather comfortable, head on a pillow and host's #alt wraped around you as one would a lover. It almost seems nice till you remember you are attached to his groin and your legs have basically merged with his massive balls. From the snoring you can assume host is still fast asleep","You wake up with host holding you close almost like a teddy bear or treasured possession. At first it almost seems odd how large he is compared to you till you feel him twitch in his sleep sending a throb through your body! Quickly reminding you of your terribly embarrassing position as a new part of his body...","You eventually open your eyes as morning greets you, host has you cuddled close. You can't help but feel embarrassed as he somtimes rubs you a bit in his sleep."+ballfixy]);
                  ...
                  case 1:
                    ...
                    if (!aroused) {
                      ...
                      if(character.sandbox.nightfun){
                             parer(["You wake up in the warmth of host's sheath, all around you is moist and sticky from the nights fun. It's opening clamped tightly around your neck like some kind of bizzare collar. From the snoring you can assume host is still fast asleep","You are woken by a wet squish noise as you adjust a bit in hosts sheath. It's warm and tight but still sticky from last nights fun. The only part of you that wasn't soaking in cum is your head is it is trapped outside by his sheath's opening like a tight collar.","A warm wet and sticky morning greets you, it seems you were soaking in last nights cum as host went to sleep. It is impossible to ignore the squishy sensation of his cum all around you in his fleshy sleeping bag of a sheath. Yet somehow it doesn't feel that weird against your skin."]);
                        
                      }else{
                        
                       parer(["You wake up in the warmth of host's sheath. It's opening clamped tightly around your neck like some kind of bizzare collar. From the snoring you can assume host is still fast asleep","You are woken by a strong rub through hosts sheath as he adjusts you. It's warm and tight with a bit of moistness. It feels like you were sleeping in a comfortable sauna with only your head outside trapped by his sheath's opening like a tight collar.","You almost want to drift back to sleep with how comfortable his thight sheath is. Like a thick warm fleshy sleeping bag, even the slightly wet inside doesn't really bother you. His sheath is tight around your neck like a weird collar that you can't pull completely inside of."]);
 ...
 character.sandbox.erect=true;
    clother();
                      ...
                      if(character.sandbox.nightfun){
                         parer(["You wake up in the warmth of host's sheath, all around you is moist and sticky from the nights fun. You can't see anything due to the sheath completely covering your head. host's musky scent overwhelms you. Especially since you have been stuck inside his sheath all night. From the snoring you can assume host is still fast asleep","You are woken by a wet squish noise as you adjust a bit in hosts sheath. It's warm and tight but still sticky from last nights fun. The scent is overwhelming, you are literally sweating it out as a normal cock would! You can't see anything due to the sheath completely covering your head.","A warm wet and sticky morning greets you, it seems you were soaking in last nights cum as host went to sleep. It is impossible to ignore the squishy sensation of his cum all around you in his fleshy sleeping bag of a sheath. Yet somehow it doesn't feel that weird against your skin. Despite being tapped unable to see in the sheath you can still hear him snoring away."]);
            ...
            oper(system,"./masturbate", "Throb desperately needing to be rubbed!" );
              ...
              "toyreward": function (character, system, action) {
                ...
                switch (character.sandbox.toyused) {
                  ...
                  parer(["After a night of teasing it feels so good to finally feel relief! You practically treasure every spurt of white sticky cum as it leaves you... Even after that the ring still sends another shiver of sensation through your over sensitive body, this time enough to wake up host! He reaches down and quickly pulls the ring off of you.... q1Geeze that wet dream mode works better than I expected... Hehe Hope you had fun too!q1 He says giving you a rub, no idea what you went through all night long!","All night you have been tortured on the edge of orgasm, every spurt of cum is like a fire hose erupting through you!... The ring doesn't care though and it buzzez away sending sharp spikes of sensetivity through you, this time enough to wake up host! He reaches down and quickly pulls the ring off of you.... q1Wow... that are not kidding about that set dream mode. Freaking intense!... From the mess you made looks like you enjoyed it too!q1 He says giving you a rub, no idea what you went through all night long!"]);
                  ...
                  case "plug":
                     character.sandbox.erect=true;
                        ...
                        parer(["You spend the night drifting in and out of sleep, each time waking up to the feeling of the huge rod stuffed down your throat! It isn't that it is uncomfortable, more so distracting. There is a certain embarrassing excitment that comes from having your throat stuffed with something that is meant to be inserted into a penis... Finally host wakes up and you expect him to pull the penis plug out but he yawns and heads for the bathroom instead!","Your night is a bit hard with a huge tube of metal holding your throat open! Then again you can't plug a throat... It's a urethra... The plug acting as a constant reminder that you are just a fun body part to play with or adorn. There is a moment of excitment as host wakes up, but he only yawns and heads for the bathroom! The plug being so comfortable he doesn't even need to remove it","The fact you manage to fall asleep at all with your entire body held rigid by the plug taking up most of your insides is rather impressive. Only a few times do you wake up confused as to why you feel so stetched open and violated! Yet it doesn't feel bad just INCREDIBLY disoncerting! Even as you are absently sucking on the plug feeling the shape of it through your body host wakes up! Seeing how well you have taken to the plug he just leaves it in and heads for the bathroom!"]);  
                        
                           if(character.sandbox.ws) {
                                if(character.sandbox.ignore) {
                           parer(["He brushes his teeth for a bit then turns around and pointing you right at the toilet, you know what is coming... but the hollow plug is still lodged inside you!","Despite your plight with the plug host just goes about his normal bathroom routine. He even points you at the toilet without removing the plug! You only have a moment of panic before remembering it is hollow. Almost as if he doesn't trust you to piss correctly","Every moment in the bathroom you wonder if he is about to remove the plug, you can't even wiggle in distress as it holds you perfectly straight! Finally you feel his grip and then the toilet comes into view, he doesn't even intend to take it out before pissing!"]);
                           
                           
                       
                      }else{
                            parer("q1You can keep sucking on that plug for a while longer, it kind of feels goodq1");
                        
                         parer(["He brushes his teeth for a bit then turns around and pointing you right at the toilet, you know what is coming... but the hollow plug is still lodged inside you!","Despite your plight with the plug host just goes about his normal bathroom routine. He even points you at the toilet without removing the plug! You only have a moment of panic before remembering it is hollow. Almost as if he doesn't trust you to piss correctly","Every moment in the bathroom you wonder if he is about to remove the plug, you can't even wiggle in distress as it holds you perfectly straight! Finally you feel his grip and then the toilet comes into view, he doesn't even intend to take it out before pissing!"]);
                           if (character.sandbox.limits.cantalk) {
                             
                              parer(["q1I don't even have to ask you to open your mouth now, nice!q1","q1This is actually way more comfortable than I expected, I don't even have to take it out to piss with!q1","q1You know I almost forgot that plug was in you, good thing its hollow!q1","q1It is really stuck in there good, hasn't buged an inch all night. Lets see if it can handle thisq1","q1Havent heard you complain about it yet, might as well leave it thereq1","q1Just let the plug do all the work, no need to worry about opening your mouth first.q1","q1All plugged up like this means you don't even have to taste the piss!q1"]);
...
//                           parer("He brushes his teeth for a bit then turns around and pointing you right at the toilet, you know what is coming... but the hollow plug is still lodged inside you! q1I don't even have to ask you to open your mouth now nice!q1");
                         ...
                         parer(["q1This is actually way more comfortable than I expected, I don't even have to take it out to piss!q1","q1You know I almost forgot that plug was in you, good thing its hollow!q1","q1It is really stuck in there good, hasn't buged an inch all night. Lets see if it can take this tooq1","q1Havent heard you complain about it yet, might as well leave it thereq1","q1Just let the plug do all the work, your only job is to keep that plug in placeq1","q1All plugged up like this means you don't even have to taste the piss! Unless you were starting to enjoy it heheq1"]);
                        }
                        }
                             
                           oper(system, "./plugbathroom", "Wait helplessly for him to start the flow");    
                    }else{// ^^ ws else not ws vv
  
                   
                  system.doLink("./permaplugnows");
                    }
    ...
    if (character.sandbox.ignore) {
                ...
                switch (character.sandbox.toyused) {
                  ...
                  case "plug":
                      ...
                      if(!character.sandbox.ignore){
                        ...
                        parer("q1You can keep sucking on that plug for a while longer, maybe it will help you learn your lessonq1");
                      }  
      ...
      system.doLink("./toysalreadyinbathroom");
            ...
            "permaplugnows": function (character, system, action) {
            transer();
       
                        
                                 character.sandbox.permaplugged=true;
                if((character.sandbox.wantplugout&&rnd()>4)){
                ...
                if(character.sandbox.permaplugged){
                   ...
                   parer(["He continues with his moring routine leaving the plug in place the entire time, every now and then enjoying the sound of the metal ring clinking as he walks.","You are helpless to do anything about the plug as host goes about his morning routine. Brushing his teeth and such as he gets ready for the day.","He makes no attempt to pull the plug out of you as he continues the morning. The ring jingles and clinks as it dangles in front of you, host actually seem to enjoy the sound of it down there."]);
                   if (character.sandbox.limits.cantalk) {
                  oper(system, "./permaplugnotalk", "Try to say something","./plugnotout","Struggle with the plug");
                        ...
                        parer(["He continues with his moring routine leaving the plug in place the entire time, every now and then enjoying the sound of the metal ring clinking as he walks. After he finishes brushing his teeth he FINALLY grabs the ring and pulls. You get dragged out of his sheath all the way before it finally slips out.","You are helpless to do anything about the plug as host goes about his morning routine. Brushing his teeth and such as he gets ready for the day. Just when you think he has decided to wear the plug the whole day he grabs it and pulls! Your whole body slips from his sheath as you are dragged out of it by the plug... Finally with a loud 'POP' It slips from your throat!"]);
                        if (character.sandbox.limits.cantalk) {
         ...
         oper(system, "./bathroom2cage", "Be a good cock and help direct his piss");
              ...
              "plugbathroom": function (character, system, action) {
                ...
                character.sandbox.permaplugged=true;
                if((character.sandbox.wantplugout&&rnd()>3)){
                    character.sandbox.permaplugged=false;
                }
                ...
                if (character.sandbox.morningvar == "sleep") {
                  ...
                  if (!character.sandbox.limits.cantalk) {
                        ...
                        if(character.qualities.day>10){
                              bath1 = ('An incredibly odd sensation suddenly wakes you, almost like a pressure spreading up your body from the inside. Once you realize WHERE you are everything starts to make sense, below you is the toilet bowl! <br> "Good morning, guess you are pretty used to this by now" host says and begins putting more pressure on his bladder as a blast of piss torrents out your mouth.... What a way to wake up...');
                        }else{
                 ...
                 //ignore scenes
                  bath1 = "";
                   if (character.sandbox.morningvar == "sleep") {
                     ...
                     bath1 = "You can hear host mumbling something about #alt in his sleep, before finally giving a short yawn and wakes up.<p> " +((character.sandbox.limits.cantalk)?("You start to say good morning to him but then stop. He is probably to sleepy too even realize you anything more than his cock. Acting like a normal cock would help him start the day easier."):("You start to say good morning but then remember your mouth is currently a vertical piss slit. He gives another yawn and carrys one without even greeting you.<p>"));
                     if(character.sandbox.ws){
                           //#piss wake up to pissing
...
//                }
              ...
              "snuggle": function (character, system, action) {
                ...
                parer(["You are large enough that it's almost like sleeping with a lover in bed, You are an comfrotable abainst his belly with the distant feeling of his balls below you. You don't really try to wake him but the movements rubbing up closer does cause him to stir. Finally he he rumbles in his sleep and reaches down to adjust his cock.... you. ","host is still holding you close to him in his sleep. It is strange to stretch and only feel your arms respond, however you do feel a pair of balls clench upwards when you try to move what was your legs. host seems to notice and begins rubbing you a bit.","It's nice and warm laying int the bed with host. Even sleeping he is rubbing over you softly, not in a sexy way. More of a loving snuggle. Too much of this though and you know it is bound to get you... drooling."]);

                character.sandbox.morningvar="snuggle";
                oper(system, "./masturbate", "Stay quiet and let him keep going", "./snugglethenbathroom", "Try not to get too excited");
             ...
             parer(["Rather than giving in to the good sensations you just relax and try your best not to get horny from his touch, it certainly isn't easy! You are left all tingly and a head full of naughty thoughts but eventually he wakes up enough to sit up and get out of bed and goes straight for the bathroom. ","You do your best to resist the urge to throb and give into the addictive sensations against your sesetive skin. It's amazing how much more intense the feelings are now that you are the very source of them! Still you manage it and host starts to wake up with a loud yawn"]);
                ...
                parer(["You quickly realize where this is headed as he stands away from the toilet pointing you right at it!","He grabs you and with a bit of manuvering points you face straight at the toilet!","You may be mostly still personish but your body still has a new function to serve. In moments hosts manuvers you around so your face points directly into the toilet!"]);
                  ...
                  oper(system, "aftermorning", "Let him finish up with the bathroom and continue with the day");
                }
              }, //function close
                ...
                switch (character.sandbox.morningvar) {
                  case "sleep":
                    ...
                    if (character.sandbox.host.host != "bret") {
                      ...
                      parer([conser,"A shudder of pleasure washes over you, then again... and again. Finally it is too much to sleep through and you start to wake up. You realize host's hand has you gipped nice and tight, sliding up and down your sensitive body! Each time you feel yourself get harder and harder, starting to throb involentarilly! It is so strange being forced to orgasm without and descion or choice! Though honestly you can't imagine a better way to be woken up in the morning!","There is a strong pressure all around your body that wakes you up rather suddenly. You hardly have time to react before that pressure slides up your shaft of a body causing a rush of sensations. You realize you are not in his sheath at all and that pressure is actually his hand wrapped around you... You got woken up in the middle of him jerking you off!!"]);
                  ...
                  case "insheath":
                    ...
                    if (character.sandbox.host.host != "bret") {
                      //NOT BRET
                      conser = ("It seems that your attempts are working but not to the desired result... Your body is getting hard and hot though! He doesn't exactly wake up but he does roll over and yawn. One of his hands suddenly reaches down to scratch, but afterwards it drifts upwards beginning to rub his sheath! <p>You can feel the pressure through it and it's hard to describe how nice it feels. Soon you can feel a strong pulsing through your body as you stiffen and become erect. host has his hands around you and is stroking you up and down. It feels REALLY good! Like a massage but its sending tingles of pleasure straight through you!  It takes surprisingly long to realize he is masturbating! It's times like this, completely drowning in pleasure that being a cock seems like the best thing in the world!");
                      parer(conser);
                      oper(system, "./masturbate2", "Enjoy the pleasure as you feel his balls tighten");
                    } else {
                      // Alright bret....
              ...
              "masturbate": function (character, system, action) {
                ...
                switch (character.sandbox.morningvar) {
                    ...
                    if (character.sandbox.host.host != "bret") {
                      ...
                      if (character.sandbox.tfed) {
                        conser = conser + "<p>Despite the wonderful feelings you do realize the night held a few changes for you. " + character.sandbox.tfholder + "<p>Yet all that seems to matter right now is the wonderful feeling of being masturbated.";
                             ...
                             parer([conser,"A shudder of pleasure washes over you, then again... and again. Finally it is too much to sleep through and you start to wake up. You realize host's hand has you gipped nice and tight, sliding up and down your sensitive body! Each time you feel yourself get harder and harder, starting to throb involentarilly! He didn't even wake you up before starting to masturbate! Honestly you can't imagine a better way to be woken up in the morning!","There is a strong pressure all around your body that wakes you up rather suddenly. You hardly have time to react before that pressure slides up your shaft of a body causing a rush of sensations. At first it just seems like host was waking you up but then he repeats the motion. Each time leaving you harder than the last. HE STARTED MASTURBATING YOU IN YOUR SLEEP!"]);
                      //parer(conser);
                      oper(system, "./masturbate2", "Enjoy the pleasures as you feel his balls begin to tighten");
                  ...
                  case "insheath":
                    ...
                    if (character.sandbox.host.host != "bret") {
                      //NOT BRET
                      conser = ("It seems that your attempts are working and you can hear a few mumbles from host. He doesn't exactly wake up but he does roll over and yawn. One of his hands suddenly reaches down to scratch, but afterwards it drifts upwards beginning to rub his sheath! <p>You can feel the pressure through it and it's hard to describe how nice it feels. Soon you can feel a strong pulsing through your body as you stiffen and become erect. host has his hands around you and is stroking you up and down. It feels REALLY good! Like a massage but its sending tingles of pleasure straight through you!  It takes surprisingly long to realize he is masturbating! It's times like this, completely drowning in pleasure that being a cock seems like the best thing in the world!");
                      parer(conser);
                      oper(system, "./masturbate2", "Enjoy the pleasure as you feel his balls tighten");
                    } else {
                      // Alright bret....
             ...
             if(character.sandbox.stealth||character.sandbox.ignore){
              ...
              "masturbatebretbase": function (character, system, action) {
                ...
                if(character.sandbox.stealth){
                       if (character.sandbox.morningvar == "awake") {
                         if(character.sandbox.pillroute){
                                 ...
                                 parer("It seems that your attempts are working but not to the desired result... Your body is getting hard and hot! He doesn't exactly wake up but he does roll over and yawn. After a bit more wiggling he finally shifts around and sits up, unfortunately this leaves you squished under him pressed firmly against the bed. <p>\"Mmmmm, Good morning down there.... Been extra horny lately....!\" He says teasing you as if he knew you were there! Every time he does that you can't help but hope! The pressure doesn't let up though as he just shifts around dragging you pleasurably against the bed. host keeps thrusting you against the slick silk sheets of his bed, and it starts to REALLY feel good!");
                         }else{
                ...
                character.sandbox.tfresponse = "";
                  ...
                  parer("It seems that your attempts are working and you can hear a few mumbles from host. He doesn't exactly wake up but he does roll over and yawn. After a bit more wiggling he finally shifts around and sits up, unfortunately this leaves you squished under him pressed firmly against the bed. There is no warning or morning greeting, just the soft rubbing of the sheets. The pressure doesn't let up as he shifts around dragging you pleasurably against the bed. " + character.sandbox.tfresponse +
                          " host keeps thrusting you against the slick silk sheets of his bed, and it starts to REALLY feel good!");
                } else {
                  parer("You wake up to a strange pleasurable but squished feeling. host seems to be laying down pressing you firmly against the bed.The pressure doesn't let up though as he just shifts around dragging you pleasurably against the slick silk sheets of his bed, and it starts to REALLY feel good!");
                ...
                ;
                  ...
                  parer("It seems that your attempts are working and you can hear a few mumbles from host. He doesn't exactly wake up but he does roll over and yawn. After a bit more wiggling he finally shifts around and sits up, unfortunately this leaves you squished under him pressed firmly against the bed. <p>\"Mmmmm, Good morning down there.... Eh another surprise morning package? Hah! Just like the first day I saw you, always hard in the morning aye?\" He says teasing you. The pressure doesn't let up though as he just shifts around dragging you pleasurably against the bed. " + character.sandbox.tfresponse +
                          " host keeps thrusting you against the slick silk sheets of his bed, and it starts to REALLY feel good!");
                } else {
                  parer("You wake up to a strange pleasurable but squished feeling. host seems to be laying down pressing you firmly against the bed.<p>\"Mmmmm, Good morning down there.... \"" + character.sandbox.tfresponse + " <p> The pressure doesn't let up though as he just shifts around dragging you pleasurably against the slick silk sheets of his bed, and it starts to REALLY feel good!");
           ...
           /* transer();
                ...
                transer();
                       ...
                       if (character.sandbox.morningvar == "awake") {
                                 ...
                                 parer("It seems that your attempts are working but not to the desired result... Your body is getting hard and hot! He doesn't exactly wake up but he does roll over and yawn. After a bit more wiggling he finally shifts around and sits up, unfortunately this leaves you squished under him pressed firmly against the bed. <p>\"Mmmmm, Good morning down there.... Been extra horny lately....!\" He says teasing you as if he knew you were there! Every time he does that you can't help but hope! The pressure doesn't let up though as he just shifts around dragging you pleasurably against the bed. host keeps thrusting you over the slick silk sheets of his bed, and it starts to REALLY feel good!");
