                ...
                "controlrune2": function(character, system, action) {
                    ...
                    switch (character.sandbox.controlprog) {
                        ...
                        case 2:
                            ...
                            if (character.qualities.essence > 60 || character.sandbox.ch2re) {
                ...
                "runeactions": function(character, system, action) {
                    ...
                    switch (character.sandbox.activerune) {
                        case "canine":
                            ...
                            if (character.sandbox.host.host == "will" || (character.sandbox.cocktype == "knot" && character.sandbox.host.cocktype == character.sandbox.cocktype)) {
