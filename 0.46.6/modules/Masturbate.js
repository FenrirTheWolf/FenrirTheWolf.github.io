    ...
    masturbate: new undum.SimpleSituation(
            ...
            actions: {
                ...
                "eveningmbnewhost": function(character, system, action) {
                    ...
                    if (character.sandbox.forgotten || character.sandbox.pillroute || character.sandbox.stealth) {
                        ...
                        if (character.sandbox.host.scenes?.[scener]&&rnd()>(7 - character.sandbox.rndmasturbate)) {
                ...
                "stealthmb": function(character, system, action) {
                    ...
                    if (character.sandbox.pillroute) {
                        ...
                        if (character.sandbox.wearoff > 0 && rnd() > 2 && character.qualities.harmony < 70) {
                            ...
                            if (character.qualities.essence >= character.sandbox.ttcost && !character.sandbox.forgotten) {
        ...
        punishment condoms: can always be used. 60% minimum
                ...
                "pillwakeup": function(character, system, action) {
                    ...
                    if (character.sandbox.ws) {
                        parer("You groggily wake up with some of the strangest dreams. You remember things from it.... but it's just you being taken out to piss over and over. Maybe showring... It is all so hazey. The last thing you remember clearly is host making you cum over and over again with that damn pill!");
                    } else {

                        parer("You groggily wake up with some of the strangest dreams. You remember things from it.... Maybe showring... host getting out of bed multiple times? It is all so hazey. The last thing you remember clearly is host making you cum over and over again with that damn pill!");
