            ...
            actions: {
                ...
                "forgottencock": function(character, system, action) {
                    ...
                    if (character.sandbox.forgottenfirst) {
                        ...
                        delay(
                            uhoh, character.sandbox.eventspeed / 2);
                    } else {
                    ...
                    if (sleepyhead && character.sandbox.ws) {
                        ...
                        if (aroused) {
                            ...
                            parer(["You wake up surrounded by cloth in complete darkness, along with a mumbling sound from above you. Your entire body feels warm and hard, enough so you find it even more difficult to move around. host apparently is going to wake up with morning wood.",
                                "You feel so hard and stiff as you start to wake up, like a pressure all through your sensetive body. host is mumbling softly above you in his sleep. You can easily feel how horny he is going to be waking up this morning.",
                                "The morning brings a sensetive thrill through your whole body as host almost humps you against the blankets, your body is hard and stiff from a serious morning erection!"
                            ]);
                            ...
                            parer(["You wake up in the warmth of host's sheath. You can't see anything due to the sheath completely covering your head. host's musky scent overwhelms you, seems you even sweat like a cock. Especially since you have been stuck inside his sheath all night.", "It is so warm and snug inside hosts sheath. The musky secent is overwhelming, you are literally sweating it out as a normal cock would! You can't see anything due to the sheath completely covering your head.", "A warm wet feeling greets you opon waking up, the sheath around you is so tight and moist with the musky sweat your body now produces. You can't even see open air with his sheath covering you up"]);
                    ...
                    if (sleepyhead && character.sandbox.ws) {
                        ...
                        switch (character.sandbox.limits.insheath) {
                            case 0:
                                ...
                                if (character.sandbox.defaulthostbackground == "lizard") {
                                    parer(["You wake up feeling rather comfortable, head on a pillow and host's #alt wraped around you as one would a lover. You then blush deeply remembering you are attached to his groin. From the snoreing you can assume host is still fast asleep", "You wake up with host holding you close almost like a teddy bear or treasured possession. At first it almost seems odd how large he is comared to you till you feel him twitch in his sleep sending a throb through your body! Quickly reminding you of your position as a new part of his body...", "You eventually open your eyes as morning greets you, host has you cuddled close. You can't help but feel a bit aroused as he somtimes rubs you a bit in his sleep. The rest of your body is just missing, excepct for the telltale sensations from his internal balls, even now you can feel them churning with cum."]);

                                } else {
                                    if (character.sandbox.enjoyit) {

                                        parer(["You wake up feeling rather comfortable, head on a pillow and host's #alt wraped around you as one would a lover.You then blush deeply remembering you are attached to his groin and your legs have basically merged with his massive balls. From the snoreing you can assume host is still fast asleep", "You wake up with host holding you close almost like a teddy bear or treasured possession. At first it almost seems odd how large he is comared to you till you feel him twitch in his sleep sending a throb through your body! Quickly reminding you of your position as a new part of his body...", "You eventually open your eyes as morning greets you, host has you cuddled close. You can't help but feel a bit aroused as he somtimes rubs you a bit in his sleep. Even if he wasn't holding you so tight, your legs are just a massive sack with host's balls inside. Even now you can feel them churning with cum."]);
                                    } else {



                                        parer(["You wake up feeling rather comfortable, head on a pillow and host's #alt wraped around you as one would a lover. It almost seems nice till you remember you are attached to his groin and your legs have basically merged with his massive balls. From the snoreing you can assume host is still fast asleep", "You wake up with host holding you close almost like a teddy bear or treasured possession. At first it almost seems odd how large he is comared to you till you feel him twitch in his sleep sending a throb through your body! Quickly reminding you of your terribly embarrassing position as a new part of his body...", "You eventually open your eyes as morning greets you, host has you cuddled close. You can't help but feel embarrassed as he somtimes rubs you a bit in his sleep. Even if he wasn't holding you so tight, your legs are nothing but a massive sack with host's balls inside. Even now you can feel them churning with cum."]);
                            ...
                            case 2:
                                ...
                                if (character.sandbox.nightfun) {
                                    parer(["You wake up in the warmth of host's sheath, all around you is moist and sticky from the nights fun. You can't see anything due to the sheath completely covering your head. host's musky scent overwhelms you. Especially since you have been stuck inside his sheath all night. From the snoreing you can assume host is still fast asleep", "You are woken by a wet squish noise as you adjust a bit in hosts sheath. It's warm and tight but still sticky from last nights fun. The musky secent is overwhelming, you are literally sweating it out as a normal cock would! You can't see anything due to the sheath completely covering your head.", "A warm wet and sticky morning greets you, it seems you were soaking in last nights cum as host went to sleep. It is impossible to ignore squishy sensation of his cum all around you in his fleshy sleeping bag of a sheath. Yet somehow it doesn't feel that weird against your skin. Dispite being tapped unable to see in the sheath you can still hear him snoring away."]);
                        ...
                        case "plug":
                            ...
                            if (character.sandbox.ws) {
                                if (character.sandbox.ignore) {
                                    ...
                                    parer(["He brushes his teeth for a bit then turns around and pointing you right at the toilet, you know what is coming... but the hollow plug is still lodged inside you!", "Dispite your plight with the plug host just goes about his normal bathroom routine. He even points you at the toilet without removing the plug! You only have a moment of panic before remembering it is hollow. Almost as if he doesn't trust you to piss correctly", "Every moment in the bathroom you wonder if he is about to remove the plug, you can't even wiggle in distress as it holds you perfectly straight! Finally you feel his grip and then the toilet comes into view, he doesn't even intend to take it out before pissing!"]);
                ...
                "masturbate": function(character, system, action) {
                    ...
                    switch (character.sandbox.morningvar) {
                        ...
                        case "insheath":
                            ...
                            if (character.sandbox.host.host != "bret") {
                                //NOT BRET
                                conser = ("It seems that your attempts are working and you can hear a few mumbles from host. He doesn't exactly wake up but he does roll over and yawn. One of his hands suddenlyreaches down to scratch, but afterwards it drifts upwards beginning to rub his sheath! <p>You can feel the pressure through it and it's hard to describe how nice it feels. Soon you can feel a strong pulsing through your body as you stiffen and become erect. host has his hands around you and is stroking you up and down. It feels REALLY good! Like a massage but its sending tingles of pleasure straight through you!  It takes surprisingly long to realize he is masturbating! It's times like this, completely drowning in pleasure that being a cock seems like the best thing in the world!");
                                parer(conser);
                                oper(system, "./masturbate2", "Enjoy the pleasure as you feel his balls tighten");
                            } else {
                                // Alright bret....
