undum.game.hospital = {
    ...
    eventhospital: new undum.SimpleSituation(
           ...
           parer("host phones ahead to let the hospital know he is coming in with a rather odd situation. He doesn't go into specifics, either out of embarrassment or he just wants to see the look on their face. He has you tightly stuffed away in his clothing making without making any attempt to hide the massive bulge you are making down there. Hypers are just a thing of porno legends, you don't tend to ever see one walking around.");
                ...
                "reveal": function (character, system, action) {
                  ...
                  if((character.sandbox.limits.cantalk)||character.qualities.harmony<50||(character.sandbox.ttcost<character.qualities.essence)){
  ...
  //                
               ...
               oper(system, "./senque", "Listen to the questions");
                ...
                "lethost": function (character, system, action) {
                  ...
                  if (character.qualities.harmony>50) {
                    ...
                    if (character.sandbox.limits.cantalk) { 
                      parer("host picks up on your lack of response and quickly says your name use to be player. Though it is probably better to just call you his cock now. Both of you have basically agreed things are better like this after all. The doctor shrugs and writes it all down.....");
                       parer("The doctor nods and then looks down to you q1I have to ask some more personal and private questions now.q1");
              ...
              oper(system, "./cumque", "Next question");
               ...
               parer("Before host responds, you wonder how you would respond if you could...");
                ...
                "cumqueyou": function (character, system, action) {
                  transer();
              parer("q1As I am sure you are aware... The secondary function of a penis is to serve as a reproductive organ. Are you capable of... orgasm and ejeculation? Does your body feel diffrent than when you were not like this?q1 he asks");
                ...
                "cumquehost": function (character, system, action) {
                  transer();
                parer("q1As I am sure you are aware... The secondary function of a penis is to serve as a reproductive organ. Have you tried to reach orgasm since this happened.... and is he still capable of ejeculation? Though most important how does he... your cock feels diffrent now than before?q1 he asks");
          ...
          if(character.qualities.harmony>50){
            ...
            parer("You do your best to deal with the slow leak of pre into you mouth as the doctor continues...");
                  system.doLink("./oops2");
                }, //function close
