              ...
              "enter": function (character, system, action) {
                ...
                switch (character.sandbox.eventholder) {
                  case "plugged":
                      ...
                      "Its only a for a few hours... After spending all night plugged a few more hours shouldn't be too bad."
                    ];
                    //delh2 here should be fine except for bret
                    if(character.sandbox.limits.cantalk){
                             delh2 = [   "With you mouth still intact you end up spending an embarrassing amount of the day just suckling on the plug with nothing better to do.",
                    ...
                    if(character.sandbox.limits.hasarms){
                      ...
                      "You keep yourself occupied thinking about how silly this all his. Trapped inside of hosts pants, stuffed in his sheath, with a metal tube plug down your throat!! If you ever see that uncle of yours again... Not only would that be rather awkward but also impossible if host decides he likes you better plugged!"];
                      ...
                      "You keep yourself occupied thinking about how silly this all his. Trapped inside of hosts pants, stuffed in his sheath, with a metal tube plug down your uretha of a throat!! If you ever see that uncle of yours again... well you won't be able to do much if you are still a cock. That would be an awkward conversation...."];
                  ...
                  case "caged":
                      ...
                      "Its only a for a few hours, it can't be that bad to just wait it out till he gets home and hopefully unlocks your cage. If he unlocks it..."
                    ];
                    //delh2 here should be fine except for bret
                    delh2 = [
                     ...
                     delh3=[
                      ...
                      "You keep yourself occupied thinking about how silly this all his. Trapped inside of hosts pants, stuffed in his sheath, locked in a chastity cage! If you ever see that uncle of yours again... well you won't be able to do much if you are still a cock. That would be an awkward conversation...."];
                ...
                break;
                    ...
                    delh1= [
                      ...
                      "Its only a for a few hours, but it's a few hours you can spend bobbing around free of his sheath."
                    ];
                    //delh2 here should be fine except for bret
                    delh2 = [
                     ...
                     delh3=[
                      ...
                      "You keep yourself occupied thinking about how silly this all his. Living as a cock and finding how easily you have taken to it!"];
                    break;
                    case "relaxout":
                 ...
                 delh1= [
                  ...
                  delh2 = [
                      ...
                      "Acting like a cock is so easy now, it is strange to think it ever felt unusual to you. In some ways you almost don't know what you would do with yourself if you had to make descisions again."
                    ];
                    delh3=[
                  ...
                  case "wait":
                   ...
                   //Maybe make a special set for just brets harness to incresse the text options.
                    ...
                    delh1= [
                      ...
                      "Its only a for a few hours, it can't be that bad to just wait it out. Might get a bit boring. But there really isn't much else to do other than wait."
                    ];
                    //delh2 here should be fine except for bret
                    delh2 = [
                     ...
                     delh3=[
                      ...
                      "You keep yourself occupied thinking about how silly this all his. Trapped inside of hosts pants, as his cock. If you ever see that uncle of yours again... well you won't be able to do much if you are still a cock. That would be an awkward conversation...."];
                    break;
                  case "horny":
                   delh1= [
                    ...
                    delh2 = [
                     (character.sandbox.limits.hasarms)? "Dispite being a bit hard to move you manage to caress your sensitive body. host is clearly distracted even to the point of moaning softly!" : "Its a bit hard without arms but you manage to wiggle around rubbing against your surrounding. host is clearly distracted even to the point of moaning softly!",
                      (character.sandbox.limits.hasarms)? "You waste no time in sliding your hands up and down your senseitve body! host lets out a grumble and moves around trying to adjust you into a more comfortable position!" : "Its a bit hard without arms but you manage to wiggle around rubbing against your surrounding. host lets out a grumble and moves around trying to adjust you into a more comfortable position!",
                    ...
                    //alt = 
                     ...
                     (character.sandbox.limits.insheath>0)?
                      ...
                      "",
                      (character.sandbox.limits.insheath>0)?
                      "host lets out a quiet grumble as you make your escape from his imprisoning sheath! You are horny and it can't stop you now! q1Nooo, what if someone sees us?! I can't play with you right now!q1 host says desperately trying to ignore you.":
                      ""];
                //parer("Its already becoming boring only 10 minutes later. You try to come up with ways to pass the timebut it eventually devolves into slowly arousing yourself. alt host is not pleased. When you start to get erect he grabs you tightly in panic till you got soft again with a grumbleing \"Stop it down there! I am busy!\". Eventually getting you to calm down and he returns to what he was doing.");
                    break;
                 ...
                 delh1= [
                  ...
                  delh2 = [
                    ...
                    delh3=[
                      "Your thoughts drift back thinking of all the good times you have had as host's cock. All the times though the years he has teased and played with you. It use to be way more often but you are patient with your owner. You feel a throb of comfort pass through you as host clenches slightly.",
                  ...
                  delh1= [
                    ...
                    delh2 = [
                     "Its a bit hard without arms but you manage to wiggle around rubbing against your surrounding. host is clearly distracted letting out a distracted moan of confusion!",
                      "Its a bit hard without arms but you manage to wiggle around rubbing against your surrounding. host lets out a grumble and moves around trying to adjust you into a more comfortable position!",
                    ...
                    //alt = 
                     ...
                     "host lets out a quiet grumble as you make your escape from his imprisoning sheath! You are horny and it can't stop you now! q1Why the heck am I getting hard all of a sudden!q1 host says desperately trying to think clean throughts."];
                       ...
                       if(character.sandbox.host.host=="dari"){
                        delh3=[
                      "It is so hard to squirm when you body is constantly hard! Half the time you spend stuck in some tight hole! In the end all you manage is to make the sex extra special for the recipient! Dari hardly even notices your attempts!",
                      "Tingles of pleasure spread through your body as host uses you! You are constantly out in the open but every twinge or movment just feels like a normal twitch of his cock! You feel so stiff now and desperate for attention between his shifts!",
                     "While Dari is taking a bit of a break you manged to stay hard not even getting pulled back into his imprisoning sheath! You are still horny and it can't stop you now! q1Ugh I am even more horny than usual today... The next person better get in her soonq1 host says desperately trying not to masturbate you."];
                ...
                case "enjoy": 
                    delh1= [
                      ...
                      "Its only a for a few hours, but it's a few hours you can spend relaxing in warmth and comfort. Cock's really have it good."
                    ];
                    //delh2 here should be fine except for bret
                    delh2 = [
                      "The day continues on as you try to pass the time. IIt is a tad boring but it's not like you could smuggle a handheld game console in here or even use one...",
                ...
                switch (hornymod) {
                  ...
                  case 2:
                   ...
                   parer("<h1>GYM</h1>");
                      ...
                      parer("host finishes up and heads downtown, you can tell by the sound of a train. Finally he enters into a somewhat familiar building, you are pretty sure it's the gym. A few moments later you hear some rustling and suddenly LIGHT! q1Hey, just doing some excersizes. Can't really let you out for long though, just had to change.q1 he says, taking off his clothes before sliding something MUCH tighter up and over you! This is WAY worse than underwear! The gym shorts now containing you buldge out over your form! Anyone looking at the shorts can totally see the buldge you are making even though you cant see them!");
                      ...
                      if(character.sandbox.permalock||character.sandbox.permaplugged){
                        if(character.sandbox.permalock){
                          ...
                          //plugged
                                                 parer("host finishes up and heads downtown, you can tell by the sound of a train. Finally he enters into a somewhat familiar building, you are pretty sure it's the gym. You can't exactly tell which piece of equipment he is using but you are suddenly squished up against it! There is a movment followed by freedom.... then another and you are all squished again! Squish release, squish release over and over! You almost feel like the plug might get pushed out by this but nope... It stays stubbornly stuck.  He doesn't do this for very long and eventually gets tired of it and heads back out.");
                        }
                        ...
                        if(character.sandbox.stayhidden){
                          //special teasing stealth
                            parer("host finishes up and heads downtown, you can tell by the sound of a train. He enters into a somewhat familiar building, you are pretty sure it's the gym. You can't exactly tell which piece of equipment he is using but you are suddenly squished up against it! There is a movement followed by freedom.... then another and you are all squished again! Squish release, squish release over and over! It doesn't hurt at least! The fabric of what he is wearing is so tight any twitch or wiggle could give away your presence! He doesn't do this for very long and eventually gets tired of it and heads back out. ");
                          
                          
                        }else{
                          //normal route
                                 parer("host finishes up and heads downtown, you can tell by the sound of a train. Finally he enters into a somewhat familiar building, you are pretty sure it's the gym. You can't exactly tell which piece of equipment he is using but you are suddenly squished up against it! There is a movment followed by freedom.... then another and you are all squished again! Squish release, squish release over and over! It doesn't hurt but it's certainly no fun! He doesn't do this for very long and eventually gets tired of it and heads back out.");
                        }//normal end
...
//                
   ...
   oper(system, "midday/enter", "Worry about what he has planned as he pays and heads out");
              ...
              "underwear": function (character, system, action) {
                ...
                oper(system, "./uw1", "Pick the first one","./uw2","Pick the second one");
              }, //function close
              "uw1": function (character, system, action) {
                transer();
                character.sandbox.uwchoice=1;
              ...
              "sellring": function (character, system, action) {
                ...
                if(character.sandbox.ignore){
                  ...
                  oper(system,"midday/enter", "Relax like like a good cock","midday/enter","Wiggle helplessly in protest");
                }else{
                    oper(system, "midday/enter", "Relax like like a good cock");
                }
             ...
             oper(system, "midday/enter", "Let him continue on with the day");
              ...
              if(character.sandbox.limits.hasarms){
                ...
                if(character.sandbox.host.host!="bret"){
                     ...
                     bathroomholder=bathroomholder+"You feel the pressure lessen and host just stays there for a few moments. He actually flicks you a few times to get the last few drops and then just holds you there pointing into the urinal. Then you feel him grasp you more firmly! Before you know it he is rubbing up and down your body sending waves of pleasure through you! You struggle a bit feeling embaressed that he is doing this IN the bathroom! Thankfully he is quick about it and soon you are shooting cum all over the urinal as he pants a bit.... q1Ahh... needed that...q1 he says putting you away still leaking a bit of cum.";
              ...
              if (character.sandbox.booksearch&&!character.sandbox.perma) {
                ...
                if ((((character.sandbox.hasbook)&&(rnd()==1||(character.sandbox.bookwork&&(rnd()>3)))))&&(character.sandbox.ring||character.sandbox.ringcheck)&&!character.sandbox.perma) {
                  ...
                  if(character.qualities.ctf==100&&(rnd(3)-hornymod)<=1&&character.sandbox.fullcock>2&&!character.sandbox.permalock&&!character.sandbox.permaplugged){
                    ...
                    if(character.sandbox.partial&&(rnd(3)-hornymod)<=1&&character.sandbox.fullcock>2&&!character.sandbox.permalock&&!character.sandbox.permaplugged){
