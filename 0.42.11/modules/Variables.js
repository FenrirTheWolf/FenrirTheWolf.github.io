...
undum.game.init = function (character, system) {
  ...
  character.sandbox = {
    ...
    runeactivate:false,
    controlprog:0,
    nogooutcount:0,       //number of days stuck in house
    rememberrune:"blank", // The setting for the research scene that carries over into nighttime I think
    ...
    ctfrolemod:"f",               //abbreviated version for use in [] variables, bod,f,pet,pos
    ...
    rewardask:false,            //PLayer wants a specific reward Need an ask menu for it though
    funvalue:0,                 //morning RND that determines if a rare event triggers during the day
    ...
    funresult:0,                 //resulter for minigame 4=success, 0=used internally, 1=too horny 2=
    ...
    pillprimer:false,         //If the host has asked to use the pills to enter forgotten cock path
    ...
    holdem:true,          //debuggy thing to prevent hosts from moving around
    docnope:false,
    piccum:false,         //doctor takes picture if you are drooling cum or not
    newhostleave:"home",      //link to leave new host to the location-y thing
    ...
    specieslist:["squirrel","horse","canine", "raccoon","tiger"],
    ...
    storestop:false,          // PLayer has said to buy nothing at the adult toy store twice
    ...
    cssreseter:false,         // check if portrait needs resetting
    morninginter:false,
    ...
    reftab: {
      ...
      human100:"builder/fullhumanoid.png",
      canine95x:"builder/fullcaninenearlyx1.png",
      human95:"builder/fullhumanoidnearly.png",
      human95x:"builder/fullhumanoidnearlyx1.png",
...
//WHAT THE HECK IS THIS! oh its.... complicated.
  ...
  function descer(character, system) {
    ...
    var sectionone = "Currently you're a simple college student, HEIGHT ish feet tall anthro XX \
    .";
    var sectionzero = "";
    var sectionthree = "";
    if (character.qualities.progress != 0) {
      switch ((Math.floor((character.qualities.progress + 3) / 4) * 20)) {
        case 20:
          sectionzero = "You're " + character.sandbox.fname + ".";
      ...
      //Fully humanoid
      console.log("Character is clear");
      sectionzero = "";
      sectionone = "";
      sectionthree = "";
    } //if close
...
//WHAT.... Turns out I just had to objectify a string... WAIT WHAT Does that even MEAN!!!!
