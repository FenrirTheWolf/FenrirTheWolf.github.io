undum.game.masturbate = {
    ...
    /////////////////////////////////////////////////////
                   ...
                   var cantalkhref="./toyask";
                   if(!character.sandbox.stealth){
                       if (((character.sandbox.limits.cantalk)||(character.sandbox.ttcost<= character.qualities.essence))) {
  ...
  //                  }
                   ...
                   if(character.sandbox.ch2){
                    ...
                    switch (character.sandbox.nightmasturbate) {
                         case 4:
    ...
    /////////////////////////////////////////////////////
                ...
                "eveningmbnewhost": function (character, system, action) {
                  ...
                  if(character.sandbox.host.scenes[scener]&&rnd()>6 ){
                ...
                "stealthmb": function (character, system, action) {
                  ...
                  if(character.sandbox.pillroute){
                    ...
                    if(character.sandbox.wearoff>0&&rnd()>2&&character.qualities.harmony<80){
                      //doesn't take it
                  ...
                  oper(system, "./forgottensend", "Relax and try to get some sleep");
                   }else{
               ...
               if(character.sandbox.ws){
                ...
                "intoforgottenskip2": function (character, system, action) {
                  ...
                  if(character.sandbox.ws){
                    ...
                    parer("Something felt strange about that.... You are awake again, but so foggy feeling. How long were you out for? It felt way longer than the last few times. You feel normal, shaft sensitive skin, comfortable sheath. Everything seems alright but something still feels off. You remeber well.... Pissing. So much! Over and over you remember being taken out to piss with. It's almost mind numbing when you think back. But that's your job afterall, there is nothing in the world you would rather do... Thinking farther back you remember... being... thinking?");
                    parer("Some of the past comes rushing back to you in bits and pieces. host must have finally stopped taking the pills after a few weeks.");
                     ...
                     parer("Something felt strange about that.... You are awake again, but so foggy feeling. How long were you out for? It felt way longer than the last few times. You feel normal, shaft sensitive skin, comfortable sheath. Everything seems alright but something still feels off. You remeber well.... Cumming. So much! Over and over you remember being taken out to for sex and jerking off. It's almost mind numbing when you think back. But that's your job afterall, there is nothing in the world you would rather do... Thinking farther back you remember... being... thinking?");
                ...
                "toyaskthrob": function (character, system, action) {
                  transer();
                  parer("You throb with excitment at his offer to use a toy to play with! Unfortuatly you are rather unable to talk with him in any meaningfull way. Helpless to day anything but let host know you would love to play with one of the toys. He thinks on it and give you a pat.<p>q1Hummm to far gone to answer... I bet you are just fakeing it so I will punish you. Such a naughty cock...q1 ");
                ...
                "askforpunishment": function (character, system, action) {
                  ...
                  parer("You tease him and tell him you really could use a little punishment for how you have been recently. Even sugguesting you might behave baddly if he doesn't... He knows you are just being playful but it seems like he is going to take the punishment seriously.... At least you get to pick the sextoy.");
                  system.doLink("./punishment2");
                }, //function close
                ...
                "lowharmony": function (character, system, action) {
                 ...
                 parer("q1You know... Even after becoming my cock you are holding up rather well. You have been a bit needy though... Just wanted to make sure you know who is in charge here. I am still going to use you like a cock, just because you lost your body doesn't mean I lost my cock. You are a penis first, person second... got it?q1 He asks.");
                      ...
                      oper(system, "./hhlowtry", "You understand and agree","./hhlownope","You don't want to replace his cock");
                      
                    }else{
                   
                      oper(system, "./hhlowtry", "(TT: "+character.sandbox.ttcost+") Tell him you understand.","./hhlownope", "(TT: "+character.sandbox.ttcost+")Tell him you don't want to replace his cock");
                ...
                "hhlownope": function (character, system, action) {
                  ...
                  if (character.sandbox.enjoyit) {
                      parer("He stops rubbing you completely when you refuse to accept your place as his cock. You may be forced to function as his cock but your body is your own even if it attached to his! It's a strange feeling though, being his cock has felt so good but you don't want to just be a cock! As fun as it might be you still need to hold onto who you are, even if that is what looks like a throbbing cock.");
                  }else{
                  parer("He stops rubbing you completely when you refuse to accept your place as his cock. You may be forced to function as his cock but your body is your own even if it attached to his! As fun as it might be you still need to hold onto who you are, even if you look like a throbbing cock.");
                  
                 
                    
                  }
                     parer("q1If you say so....q1 he says and rolls over in the blankets. You are left rather hot and bothered not getting the fun pay off that you were building up to! Maybe if you had said yes he would have kept going!??");
             ...
             character.sandbox.erect=true;
                ...
                "eveningmbbret": function (character, system, action) {
                  ...
                  switch (rnd(4)) {
                    case 1:
                      ...
                      break;
                    case 2:
                      parer("Bret forces you into the sex sleeve over and over. Each time causing it to drag over your body quicker than the last! Every inch of you body is just an organ meant for pleasure. You would wiggle and squirm from it all if you were not as hard as a rock! A deep pressure starting to build....");
                      break;
                    case 3:
                      parer("Bret forces you into the sex sleeve letting it's tight grip slide up and down your body with every thrust of his hips. It feels like pure bliss as a strange sensation spreads through your cock like body. In and out... in and out! You mind feels like it's getting fucked silly as the sensations build! A deep pressure starting to build....");
                      break;
                    case 4:
                      parer("Bret thrusts you into the tight sleeve like a wild animal leaping onto their prey! He doesn't hold back at all as he uses your body for his own pleasure! The toy is so tight! And slick textured insides! Your cock shaped head sticks out the fron ot it with each thrustA deep pressure starting to build....");
                  break;
                  }//End of RND switch
                ...
                "endmb": function (character, system, action) {
                  ...
                  if(character.sandbox.limits.cantalk){
                    ...
                    //has a piss slit!
                     parer("That pressure suddenly breaks like a damn as host's orgasm hits! Your entire body tenses up and you can literally feel the veins connecting you to him. It is never clearer how strong his hold on your body is than during an orgasm! The urethra running through your body fills and cum bursts from the verticle slit of your mouth! There just isn't enough of you left to do anything but spurt it out onto the bed like any cock would!");
                    parer("After that you can only remember some of it. Mostly struggling with the cum that seemed to non stop leak from your mouth... Your body softened and you just wanted to rest... host cleaned you up a bit then slipped back to sleep feeling much relieved.");
        ...
        punishment condoms: can always be used. 60% minimum
                ...
                parer("host heads to his bed room after a long day. He hasn't been very happy with you after what happened. He takes a seat and just gives you a glare."+character.host["punish"+character.sandbox.ctfrolemod]);
                 ...
                 }else if(character.qualities.essence>character.sandbox.ttcost){
        ...
        system.doLink("./punishment2");
                ...
                "punishment2": function (character, system, action) {
                  ...
                  if((!character.sandbox.toys.plug)&&character.qualities.ctf>=40||debugtest){
                 ...
                 if(character.sandbox.toys.condoms&&character.qualities.ctf>=40||debugtest){
                  
                  toyholder.push("condoms");
                }
                     if(character.sandbox.toys.cage&&character.qualities.ctf>=95&&((!character.sandbox.ringstuck)||character.sandbox.runedo.stability||character.sandbox.perma)||debugtest){
                    console.log("cage check ");
                  toyholder.push("cage");
                }
                  if((!character.sandbox.toys.beads)&&character.qualities.ctf>=40&&(!character.sandbox.limits.cantalk||debugtest)){
                  
                  toyholder.push("beads");
                }
                 
        
                   if(character.sandbox.toys.bondage&&character.qualities.ctf<50&&character.sandbox.limits.hasarms&&false){
  ...
  //                     
                ...
                "rewardask": function (character, system, action) {
                  ...
                  character.sandbox.ttcarryover=false;
                  parer("You cautiously ask him what he is planning. You know HE thinks it will be fun but that doesn't nesscessarily mean you will find it fun. Still you would rather know what he has planned before just letting him play with you. Though you ARE his cock now, so he really should get to play with you whenever HE decides to.");
                  if (character.sandbox.ignore) {
                ...
                var debugtest=false;
                 ...
                 if(character.sandbox.toys.condoms&&character.qualities.ctf>=40||debugtest){
                  ...
                  toyholder.push("condoms");
                     ...
                     if((!character.sandbox.toys.vibe)&&character.qualities.ctf>=40||debugtest){
  ...
  //                parer("He pulls out a VERY concerning looking object! You know a chastity cage when you see one! With no arms or any say in what happens all you can do is watch as the metal cage slowly decends towards you! It is damn cold at first and he makes sure you ar all the way inside. The next piece goes ");
              ...
              oper(system, "./plugrub", "Throb as this starts to get more intense!");
                ...
                "condomcum": function (character, system, action) {
                  ...
                  if (character.sandbox.limits.cantalk) {
                    ...
                    parer("All the wonderful sensations build up all at once as you feel a familiar tightness in host's balls! Once again you are drowned in orgasmic bliss as the urethral bulge long your belly expands visably all the way up your neck! The cum floods into your mouth and then begins filling the condom! Each clench of his balls sending another spurt of cum through your body. Soon it isn't just orgasmic bliss you are drowning in! The condom is literally ballooning with cum! You can't see anything through the thick white sea!");
                      ...
                      parer("All the wonderful sensations build up all at once as you feel a familiar tightness in host's balls! Once again you are drowned in orgasmic bliss as the urethral bulge long your belly expands visably all the way up your body! The cum shoots from your verticle slit of a mouth and begins filling the condom! Each clench of his balls sending another spurt of cum through your body. Soon it isn't just orgasmic bliss you are drowning in! The condom is literally ballooning with cum! You can't see anything through the thick white sea!");
                ...
                "condomcumletout": function (character, system, action) {
                  ...
                  //reward
                  transer();
                  parer("host seems to understand and with a chuckle angles you body downward as he slowly slides the condom off of your body. He is carfull enough to make sure that most of the cum gets rubbed off into the condom in the process. Even though you don't have to breath you instinctively feel the need to gasp as you finally are free! host rubs you down with a tissue cleaning you off as best he can. You get pulled back into his sheath and soon after he lays down fliping the blanket back over you both.");
            ...
            "pill": function (character, system, action) {
                  ...
                  if(character.sandbox.ignore){
                    ...
                    parer("host pulls out something from a drawer... It looks like a bottle of pills. q1So I got these as a gift from the guy at the adult store. It says they give you 0 refractory period and you can cum over and over. He described it as an aphrodisiac on steroids. Not sure how effective as a punishment this is going to be, but I know I am going to enjoy it.q1 He says opening the bottle and taking one of the pills.");
                ...
                "pillprotest": function (character, system, action) {
                  ...
                  if(character.sandbox.ttcost<character.qualities.essence) {
                    system.setQuality("essence",character.qualities.essence- character.sandbox.ttcost );
                    parer("You try to protest a bit but its hard to put up a decent argument considering you are already his penis. Just making you act and feel like it is just a logical step. He doesn't even respond to you, instead just starting to rub you even faster!");
                  }else{
                ...
                "pillcum": function (character, system, action) {
                   if (character.sandbox.host.host=="bret") {
                  parer("Bret just keeps humping you into the bed, over and over sliding you against it! Finally he can't take it any more and gets out that tube thing he has used before. He forces you in head first as he holds it in place thrusting away! Sudenly all the sensations get magnified 10 fold!");  
                ...
                "pillwakeupdoom": function (character, system, action) {
                 ...
                 "pillwakeup": function (character, system, action) {
                  ...
                  if (character.sandbox.ws) {
                    parer("You groggily wake up with some of the strangest dreams. You remember things from it.... but it's just you being taken out to piss over and over. Maybe showring... It is all so hazy. The last thing you remember clearly is host making you cum over and over again with that damn pill!");
                  }else{
                    
                    parer("You groggily wake up with some of the strangest dreams. You remember things from it.... Maybe showring... host getting out of bed multiple times? It is all so hazy. The last thing you remember clearly is host making you cum over and over again with that damn pill!");
                  ...
                  system.setQuality("dayofweek", character.qualities.day%7);
                   if (character.qualities.dayofweek>4){
                    ...
                    character.sandbox.usedpillsonce=true;
                     if(character.sandbox.ignore){
                    if(character.qualities.ctf==100){
                      parer("q1Day 5.... Damn maybe I really did cum his mind blank. Guess he really is just a normal cock now...q1 He says and goes about his day. He really thinks you are not there any more.... ");
                      
                    }else{
                      parer("host is just getting up and happens to look in the mirror seeing you... q1It's so easy to forgot my cock is a bit unusual.... If you are in there still you have been doing great bytheway. Just stay like you have been the last few days, that's what a good cock should be like afterall.q1 He says and goes about his day. It feels a tad embarrassing for your exsistance as his cock to be just a 'a bit unusual'. Then again comparing you to a normal cock maybe there really isn't that much of a differnece.");
                    ...
                    parer("q1Day 5.... Damn mayabe I really did cum his mind blank."+character.host.pillwake+"q1 He says paying close attention to you");
                    if(character.sandbox.perma){
                      ...
                      parer("You have to do something to let him know you are there, but if you ever decided to stay like this forever... The thought of agreeing to be his cock permanetly sends shivers through you. This would be very different if you had...");
                      oper(system, "./pillthrob", "Throb to let him know you are there!","./pillthrob","Reluctantly wiggle a bit");
                    }
               ...
               delay(pillholder);
                ...
                "pillalert": function (character, system, action) {
                  ...
                  oper(system, "./pillwearoff", "Hope it wears off soon!","./realcock","Consider becomeing a REAL cock");
                }, //function close
            ...
            "punishbeads": function (character, system, action) {
                  ...
                  transer();
                  parer("host thankfully takes his time pushing the first one in. Thanks to the liberal coating of lube it slips inside what use to be your mouth. It really feels like there is a big apple or ball bag holding it open. You are rather helpless as another starts to push its way in, causing the first to start slipping down what feels like your throat. It causes a twinge of embarrassment thinking how your throat has been repurposed to function as a urethra'");
                  oper(system, "./punishbead2", "Feel the next one slide in");
                }, //function close
                "punishbead2": function (character, system, action) {
                  transer();
             parer("host pushes another in causing the first one to travel even farther down your urethra.  A very visable bulge slides down where your neck use to be, clearly showing exactly where the large bead is currently lodged. The pressure inside you feels really odd, stetching around an object where normally nothing but liquid would travel through. One after another get forced down till you have a whole line of them visably making bumps along your underside.");
             parer("You get a bit of a surprise as the newest bead that popps into your mouth is much larger than the last one! You hear a concerning chuckle from host after that.");
                ...
                "rewardbeads": function (character, system, action) {
                  transer();
                   parer("host takes his time thankfully pushing the first one in. Thanks to the liberal coating of lube it slips inside what use to be your mouth. It really feels like there is a big apple or ball bag holding it open. The sensations are so strange yet kind of exciting. Soon another follows causing first to start slipping down what feels like your throat. It causes a twinge of embarrassment thinking how your throat has been repurposed to function as a urethra.");
                  oper(system, "./rewardbeads2", "Be a good cock and take those beads!");
                }, //function close
                "rewardbeads2": function (character, system, action) {
                  transer();
                  parer("host pushes another in causing the first one to travel even farther down your urethra.  A very visable bulge slides down where your neck use to be, clearly showing exactly where the large bead is currently lodged. The pressure inside you feels really odd, stetching around an object where normally nothing but liquid would travel through. host just lets out a softly mumble of pleasure as he goes to push the next few! One after another get forced down till you have a whole line of them visably making bumps along your underside. After that host takes a moment to just enjoy how it feels.");
                  
                  oper(system, "./rewardbeadsstop", "Try to get use to the weird feeling");
                }, //function close
                 "rewardbeadsstop": function (character, system, action) {
                  transer();
                  parer("host seems to take this as the perfect oppertunity to ramp up the fun, rubbing up and down your urethra. That REALLY feels strange! It is much stranger feeling, a mixture of throat and soft sensitive flesh filled with thick objects. Then he gives a soft pull.....");
                ...
                "swallowstop": function (character, system, action) {
                  transer();
                  parer("You decide it's better not to risk it. host seems to take this as the perfect oppertunity to ramp up the fun, rubbing up and down your urethra. That REALLY feels strange! It is much stranger feeling, a mixture of throat and soft sensitive flesh filled with thick objects. Then he gives a soft pull.....");
