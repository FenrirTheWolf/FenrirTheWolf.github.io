              ...
              clother();
                ...
                switch (character.sandbox.ctfrole) {
                  ...
                  case "possessive":
                    ...
                    parer("host makes sure you can see yourself in the mirror for a few moments. Just to remind you how good you look between his legs before hiding your within his pants right where you belong. After that he starts getting breakfast, occasionally giving you a firm rub possessivly.");
                  ...
                  case "friend":
                   //
                   parer("host leaves you out for most of the morning. Getting breakfast and talking with you before eventually deciding to put some pants on for the day. q1Sorry, but I got to get dressed. I'll let you back out laterq1 He says and pulls up his pants over you. He still occasionally says something to you but only passivly.");
                ...
                "stay": function (character, system, action) {
                  ...
                  if(character.sandbox.permalock||character.sandbox.permaplugged){
                    if(character.sandbox.permalock){
                           parer("You stay in his pants trying enjoy what they are doing, at least you get to hear it going on. Sort of like listening to a friend in another room doing something while you are stuck in the time out corner. Except your corner is a set of tight metal rings holding you prisoner in your own sheath!");  
                  
                    }else{
                        parer("You stay in his pants trying enjoy what they are doing, at least you get to hear it going on. With the plug in your mouth you would probarbly just leak all over is crotch anyway if he let you out.");  
                  
                    }
                    
                  }else{
                       parer("You stay in his pants trying enjoy what they are doing, at least you get to hear it going on. Sort of like listening to a friend in another room doing something. Passive company. It normally would be super weird to be waving ones cock around during something like this you have to admit.");  
