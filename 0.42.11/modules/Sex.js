             ...
             */
              ...
              if(character.sandbox.metbefore[character.sandbox.splistchoice][0]){
                ...
                if(character.qualities.ctf<40&&why){
                  //BIG
                  if(character.sandbox.host.pref=="straight"){
                     parer("You hear some talking from host and someone else and soon you are getting pulled out into the open. Almost instatnly you start getting hard as you look up to see the" + bigspecieslist[character.sandbox.splistchoice]+" smiling down at you! She is absolutely massive, not in a bad way.... Then again you are rather shorter than you use to be but still they are intimidating!");
                  }else{
                     parer("You hear some talking from host and someone else and soon you are getting pulled out into the open. Almost instatnly you start getting hard as you look up to see the" + bigspecieslist[character.sandbox.splistchoice]+" smiling down at you! He is absolutely massive, not in a bad way.... Then again you are rather shorter than you use to be but still she is intimidating!");
