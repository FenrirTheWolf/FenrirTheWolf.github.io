 ...
 */
 ...
 undum.game.version = "0.42";
 var patchversion = ".11";
 //document.getElementById("versionnum").innerHTML ="v"+undum.game.version+patchversion;
 
 document.getElementById("versionnum").innerHTML = undum.game.version + patchversion;
 ...
 //              }
   ...
   learnmore: new undum.SimpleSituation(
    "",
    {
      heading: "Ask him to spend more time researching the runes",
      tags: ["choice"],
      canView:
 ...
 //                      }
    ...
    "",
    {
      heading: "Beg him to take the cage off",
      tags: ["choice"],
      displayOrder: 3,
      canView:
       function (character, system, host) {
    ...
    "",
    {
      heading: "Beg him to take the plug out",
      tags: ["choice"],
      displayOrder: 3,
      canView:
       function (character, system, host) {
      ...
      actions: {
           "cockmetemp": function (character, system, action) {
             transer();
                   ...
                   if(character.sandbox.host.cockmeplz1==""){
    ...
    "",
    {
      ...
      enter:
       function (character, system, from) {
         ...
         if (rnd() > 5) {
           if (character.sandbox.host.harmony[3] > 20 && (character.host.cockmeplz != 0)) {
 
             character.sandbox.host.harmony[3] = ((character.sandbox.host.harmony[3]) - 5);
             character.host.cockmeplz--;
    ...
    "",
    {
      ...
      actions: {
        "nice": function (character, system, action) {
          transer();
          if (rnd() < character.qualities.harmony - 2 || character.sandbox.enjoyit) {
        ...
        "demand": function (character, system, action) {
          ...
          if (rnd() > 8) {
            ...
            oper(system, "preworksender/prework", "Thank him as he continues getting ready.");
            character.sandbox.booksearch = true;
          } else if (character.qualities.harmony > 55) {
        ...
        "prework": function (character, system, action) {
          ...
          switch (character.sandbox.funvalue) {
            ...
            if(character.sandbox.permalock){
                parer("host finishes getting ready for dayjob and makes his way out the door.  The trip there is uneventful and the swaying back and forth as he walks just makes it harder to relax. Meanwhile you practially ");
              
              
            }else if(character.sandbox.permaplugged){
              
              parer("host finishes getting ready for dayjob and makes his way out the door.  The trip there is uneventful and the swaying back and forth as he walks just makes it harder to relax. Meanwhile you have to get through the entire day with feeling like your mouth is getting fucked by a metal horse!");
              
            }else if(character.sandbox.ch2){
                  parer("host finishes getting ready for dayjob and makes his way out the door.  The trip there is uneventful and the swaying back and forth as he walks just makes it harder to relax. host expects you to stay unmoving and quiet for hours with nothing to do, you are practically an expert at acting like a cock by now though.");
 
            }else{
               parer("host finishes getting ready for dayjob and makes his way out the door.  The trip there is uneventful and the swaying back and forth as he walks just makes it harder to relax. host expects you to stay unmoving and quiet for hours with nothing to do, easy for a normal cock to do. However a normal cock doesn't get bored!");
 }
